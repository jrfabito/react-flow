...
class AbstractWrapper {
    ...
    findAllComponents(ComponentClass, selector) {
        const componentRootSelector = (0, utils_1.getComponentRootSelector)(ComponentClass);
     ...
     * @returns `Wrapper | null`
     */
    findClosestComponent(ComponentClass) {
        const componentRootSelector = (0, utils_1.getComponentRootSelector)(ComponentClass);
        const closestElement = this.element.closest(componentRootSelector);
