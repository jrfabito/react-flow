...
exports.KeyCode = exports.getUnscopedClassName = exports.getComponentRootSelector = exports.appendSelector = exports.substituteScope = exports.isScopedSelector = exports.escapeSelector = void 0;
const Tokenizer = __importStar(require("css-selector-tokenizer"));
require("css.escape");
...
const substituteScope = (selector, scope) => {
...
const trimContentHash = (className) => {
...
function getComponentRootSelector(componentClass) {
...
exports.getComponentRootSelector = getComponentRootSelector;
const getUnscopedClassName = (selector) => {
