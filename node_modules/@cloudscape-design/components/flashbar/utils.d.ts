...
export declare function isStackableItem(item: StackableItem | FlashbarProps.MessageDefinition): item is StackableItem;
export declare function isRefObject<T>(ref: unknown): ref is React.RefObject<T>;
...
export declare function getStylePropertyKey(type: FlashbarProps.Type): string;
