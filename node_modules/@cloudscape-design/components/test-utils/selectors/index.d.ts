...
declare module '@cloudscape-design/test-utils-core/dist/selectors' {
  interface ElementWrapper {
     ...
     *
     * @param {string} [selector] CSS Selector
     * @returns {DividerWrapper}
     */
    findDivider(selector?: string): DividerWrapper;
    /**
     * Returns a multi-element wrapper that matches Dividers with the specified CSS selector.
     * If no CSS selector is specified, returns a multi-element wrapper that matches Dividers.
     *
     * @param {string} [selector] CSS Selector
     * @returns {MultiElementWrapper<DividerWrapper>}
     */
    findAllDividers(selector?: string): MultiElementWrapper<DividerWrapper>;
    /**
    ...
    /**
     * Returns a wrapper that matches the Skeletons with the specified CSS selector.
     * If no CSS selector is specified, returns a wrapper that matches Skeletons.
     *
     * @param {string} [selector] CSS Selector
     * @returns {SkeletonWrapper}
     */
    findSkeleton(selector?: string): SkeletonWrapper;
    /**
     * Returns a multi-element wrapper that matches Skeletons with the specified CSS selector.
     * If no CSS selector is specified, returns a multi-element wrapper that matches Skeletons.
     *
     * @param {string} [selector] CSS Selector
     * @returns {MultiElementWrapper<SkeletonWrapper>}
     */
    findAllSkeletons(selector?: string): MultiElementWrapper<SkeletonWrapper>;
    /**
