...
const truncated_text_1 = require("./truncated-text");
exports.TruncatedTextWrapper = truncated_text_1.default;
...
selectors_1.ElementWrapper.prototype.findDivider = function (selector) {
...
selectors_1.ElementWrapper.prototype.findAllDividers = function (selector) {
...
selectors_1.ElementWrapper.prototype.findSkeleton = function (selector) {
...
selectors_1.ElementWrapper.prototype.findAllSkeletons = function (selector) {
...
selectors_1.ElementWrapper.prototype.findTruncatedText = function (selector) {
    let rootSelector = `.${truncated_text_1.default.rootSelector}`;
    if ("legacyRootSelector" in truncated_text_1.default && truncated_text_1.default.legacyRootSelector) {
        rootSelector = `:is(.${truncated_text_1.default.rootSelector}, .${truncated_text_1.default.legacyRootSelector})`;
    }
    // casting to 'any' is needed to avoid this issue with generics
    // https://github.com/microsoft/TypeScript/issues/29132
    return this.findComponent(selector ? (0, utils_1.appendSelector)(selector, rootSelector) : rootSelector, truncated_text_1.default);
};
selectors_1.ElementWrapper.prototype.findAllTruncatedTexts = function (selector) {
    return this.findAllComponents(truncated_text_1.default, selector);
};
