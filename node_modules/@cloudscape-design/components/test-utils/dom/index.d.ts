...
declare module '@cloudscape-design/test-utils-core/dist/dom' {
  interface ElementWrapper {
    ...
    /**
     * Returns the wrapper of the closest parent ActionCard for the current element,
     * or the element itself if it is an instance of ActionCard.
     * If no ActionCard is found, returns `null`.
     *
     * @returns {ActionCardWrapper | null}
     */
    findClosestActionCard(): ActionCardWrapper | null;
    /**
     ...
     * If no matching Divider is found, returns `null`.
     *
     * @param {string} [selector] CSS Selector
     * @returns {DividerWrapper | null}
     */
    findDivider(selector?: string): DividerWrapper | null;
    /**
     * Returns an array of Divider wrapper that matches the specified CSS selector.
     * If no CSS selector is specified, returns all of the Dividers inside the current wrapper.
     * If no matching Divider is found, returns an empty array.
     *
     * @param {string} [selector] CSS Selector
     * @returns {Array<DividerWrapper>}
     */
    findAllDividers(selector?: string): Array<DividerWrapper>;
    /**
     * Returns the wrapper of the closest parent Divider for the current element,
     * or the element itself if it is an instance of Divider.
     * If no Divider is found, returns `null`.
     *
     * @returns {DividerWrapper | null}
     */
    findClosestDivider(): DividerWrapper | null;
    /**
    ...
    /**
     * Returns the wrapper of the first Dropdown that matches the specified CSS selector.
     * If no CSS selector is specified, returns the wrapper of the first Dropdown.
     * If no matching Dropdown is found, returns `null`.
     *
     * @param {string} [selector] CSS Selector
     * @returns {DropdownWrapper | null}
     */
    findDropdown(selector?: string): DropdownWrapper | null;
    /**
     * Returns an array of Dropdown wrapper that matches the specified CSS selector.
     * If no CSS selector is specified, returns all of the Dropdowns inside the current wrapper.
     * If no matching Dropdown is found, returns an empty array.
     *
     * @param {string} [selector] CSS Selector
     * @returns {Array<DropdownWrapper>}
     */
    findAllDropdowns(selector?: string): Array<DropdownWrapper>;
    /**
     * Returns the wrapper of the closest parent Dropdown for the current element,
     * or the element itself if it is an instance of Dropdown.
     * If no Dropdown is found, returns `null`.
     *
     * @returns {DropdownWrapper | null}
     */
    findClosestDropdown(): DropdownWrapper | null;
    /**
    ...
    /**
     * Returns the wrapper of the first ItemCard that matches the specified CSS selector.
     * If no CSS selector is specified, returns the wrapper of the first ItemCard.
     * If no matching ItemCard is found, returns `null`.
     *
     * @param {string} [selector] CSS Selector
     * @returns {ItemCardWrapper | null}
     */
    findItemCard(selector?: string): ItemCardWrapper | null;
    /**
     * Returns an array of ItemCard wrapper that matches the specified CSS selector.
     * If no CSS selector is specified, returns all of the ItemCards inside the current wrapper.
     * If no matching ItemCard is found, returns an empty array.
     *
     * @param {string} [selector] CSS Selector
     * @returns {Array<ItemCardWrapper>}
     */
    findAllItemCards(selector?: string): Array<ItemCardWrapper>;
    /**
     * Returns the wrapper of the closest parent ItemCard for the current element,
     * or the element itself if it is an instance of ItemCard.
     * If no ItemCard is found, returns `null`.
     *
     * @returns {ItemCardWrapper | null}
     */
    findClosestItemCard(): ItemCardWrapper | null;
    /**
    ...
    /**
     * Returns the wrapper of the first Skeleton that matches the specified CSS selector.
     * If no CSS selector is specified, returns the wrapper of the first Skeleton.
     * If no matching Skeleton is found, returns `null`.
     *
     * @param {string} [selector] CSS Selector
     * @returns {SkeletonWrapper | null}
     */
    findSkeleton(selector?: string): SkeletonWrapper | null;
    /**
     * Returns an array of Skeleton wrapper that matches the specified CSS selector.
     * If no CSS selector is specified, returns all of the Skeletons inside the current wrapper.
     * If no matching Skeleton is found, returns an empty array.
     *
     * @param {string} [selector] CSS Selector
     * @returns {Array<SkeletonWrapper>}
     */
    findAllSkeletons(selector?: string): Array<SkeletonWrapper>;
    /**
     * Returns the wrapper of the closest parent Skeleton for the current element,
     * or the element itself if it is an instance of Skeleton.
     * If no Skeleton is found, returns `null`.
     *
     * @returns {SkeletonWrapper | null}
     */
    findClosestSkeleton(): SkeletonWrapper | null;
    /**
