...
dom_1.ElementWrapper.prototype.findTruncatedText = function (selector) {
...
dom_1.ElementWrapper.prototype.findAllTruncatedTexts = function (selector) {
...
dom_1.ElementWrapper.prototype.findClosestTruncatedText = function () {
    // casting to 'any' is needed to avoid this issue with generics
    // https://github.com/microsoft/TypeScript/issues/29132
    return this.findClosestComponent(truncated_text_1.default);
};
