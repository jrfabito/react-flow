...
// eslint-disable-next-line @cloudscape-design/build-tools/ban-files
import { I18nProvider } from './provider';
export default function TestI18nProvider({ messages = {}, locale = 'en', children }) {
    return (React.createElement(I18nProvider, { locale: locale, messages: [{ [namespace]: { [locale]: messages } }] }, children));
}
