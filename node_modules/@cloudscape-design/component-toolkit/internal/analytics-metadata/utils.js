...
const getGeneratedAnalyticsMetadata = (target, options) => {
    let metadata = {};
    ...
    while (currentNode) {
        try {
            ...
            if (currentMetadataString) {
                ...
                metadata = (0, metadata_utils_js_1.mergeMetadata)(metadata, (0, metadata_utils_js_1.processMetadata)(currentNode, currentMetadata, options));
            }
        }
        catch {
            /* empty */
