...
function detectVisualRefreshFlag() {
    ...
    return (_b = (_a = global === null || global === void 0 ? void 0 : global[index_js_4.awsuiVisualRefreshFlag]) === null || _a === void 0 ? void 0 : _a.call(global)) !== null && _b !== void 0 ? _b : !!(0, index_js_4.getGlobalFlag)('oneTheme');
}
...
const THEMES = {
    [Theme.VisualRefresh]: {
        ...
        isFlagActive: () => { var _a, _b; return !!((_b = (_a = (0, index_js_4.getGlobal)()) === null || _a === void 0 ? void 0 : _a[index_js_4.awsuiVisualRefreshFlag]) === null || _b === void 0 ? void 0 : _b.call(_a)); },
    },
    [Theme.OneTheme]: {
        className: 'awsui-one-theme',
        isFlagActive: () => !!(0, index_js_4.getGlobalFlag)('oneTheme'),
    },
};
