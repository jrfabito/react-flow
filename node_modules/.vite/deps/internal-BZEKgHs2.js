...
import { t as processAttributes } from "./with-native-attributes-B0xgeG3E.js";
...
import { n as InternalDropdown, t as options_list_default } from "./options-list-CrIORcfH.js";
...
import { c as useVirtual, d as selectable_item_default, f as Option, h as useDropdownStatus, l as generateTestIndexes, m as DropdownFooter, n as useAnnouncement, p as getDropdownMinWidth, r as checkOptionValueField, t as useHighlightedOption, u as getTestOptionIndexes } from "./use-highlight-option-CHKivnUu.js";
import { t as internal_default } from "./internal-Cp3Ht2C9.js";
import { t as checkControlled } from "./check-controlled-B0nHWBFl.js";
import "/Users/jrfabito/Documents/Job Search/react-flow/node_modules/@cloudscape-design/components/internal/components/autosuggest-input/styles.scoped.css";
import "/Users/jrfabito/Documents/Job Search/react-flow/node_modules/@cloudscape-design/components/autosuggest/styles.scoped.css";
//#region node_modules/@cloudscape-design/components/internal/hooks/use-ime-composition/index.js
...
*/
function useIMEComposition(elementRef, { onCompositionStart, onCompositionEnd } = {}) {
	const wasComposingRef = (0, import_react.useRef)(false);
	const onCompositionStartRef = (0, import_react.useRef)(onCompositionStart);
	onCompositionStartRef.current = onCompositionStart;
	const onCompositionEndRef = (0, import_react.useRef)(onCompositionEnd);
	onCompositionEndRef.current = onCompositionEnd;
	const handleCompositionStart = () => {
		var _a;
		wasComposingRef.current = true;
		(_a = onCompositionStartRef.current) === null || _a === void 0 || _a.call(onCompositionStartRef);
	};
	const handleCompositionEnd = () => {
		var _a;
		(_a = onCompositionEndRef.current) === null || _a === void 0 || _a.call(onCompositionEndRef);
...
//#endregion
//#region node_modules/@cloudscape-design/components/internal/components/autosuggest-input/styles.css.js
...
//#endregion
//#region node_modules/@cloudscape-design/components/internal/components/autosuggest-input/index.js
var AutosuggestInput = import_react.forwardRef(({ value, onChange, onBlur, onFocus, onKeyUp, onKeyDown, name, placeholder, disabled, readOnly, autoFocus, ariaLabel, ariaRequired, disableBrowserAutocorrect = false, expandToViewport, ariaControls, ariaActivedescendant, clearAriaLabel, dropdownExpanded = true, dropdownContentKey, dropdownContentFocusable = false, dropdownContent = null, dropdownFooter = null, dropdownWidth, loopFocus, nativeInputAttributes, onCloseDropdown, onDelayedInput, onPressArrowDown, onPressArrowUp, onPressEnter, style, __internalRootRef, ...restProps }, ref) => {
	const baseProps = getBaseProps(restProps);
	const formFieldContext = useFormFieldContext(restProps);
	const inputRef = (0, import_react.useRef)(null);
	const dropdownContentRef = (0, import_react.useRef)(null);
	const dropdownFooterRef = (0, import_react.useRef)(null);
	const preventOpenOnFocusRef = (0, import_react.useRef)(false);
	const preventCloseOnBlurRef = (0, import_react.useRef)(false);
	...
	(0, import_react.useImperativeHandle)(ref, () => ({
		focus(options) {
			var _a;
			if (options === null || options === void 0 ? void 0 : options.preventDropdown) preventOpenOnFocusRef.current = true;
			(_a = inputRef.current) === null || _a === void 0 || _a.focus();
		},
		select() {
			var _a;
			(_a = inputRef.current) === null || _a === void 0 || _a.select();
		},
		open: openDropdown,
		close: closeDropdown
	}));
	...
	const handleEscapeKey = (returnFocus) => {
		...
		if (open) {
			closeDropdown();
			if (returnFocus) (_a = inputRef.current) === null || _a === void 0 || _a.focus();
		} else if (value) fireNonCancelableEvent(onChange, { value: "" });
	};
	const handleKeyDown = (event) => {
		switch (event.detail.keyCode) {
			case KeyCode.down:
				onPressArrowDown === null || onPressArrowDown === void 0 || onPressArrowDown();
				openDropdown();
				event.preventDefault();
				break;
			case KeyCode.up:
				onPressArrowUp === null || onPressArrowUp === void 0 || onPressArrowUp();
				openDropdown();
				event.preventDefault();
				break;
			case KeyCode.enter:
				...
				if (open) {
					if (!(onPressEnter === null || onPressEnter === void 0 ? void 0 : onPressEnter())) closeDropdown();
					event.preventDefault();
				}
				fireKeydown(event);
				break;
	...
	const handleDropdownMouseDown = (event) => {
		if (!dropdownContentFocusable) event.preventDefault();
		else {
	...
	(0, import_react.useEffect)(() => {
		...
		const clickListener = (event) => {
			if (!nodeBelongs(inputRef.current, event.target) && !nodeBelongs(dropdownContentRef.current, event.target) && !nodeBelongs(dropdownFooterRef.current, event.target)) closeDropdown();
		};
	...
	return import_react.createElement("div", {
		...
		onFocus: handleFocus,
		onBlur: handleBlur,
		trigger: import_react.createElement(internal_default, {
			type: "visualSearch",
			value,
		...
		footer: dropdownFooterRef && import_react.createElement("div", {
			ref: dropdownFooterRef,
			className: styles_css_default$1["dropdown-footer"],
			onKeyDown: handleDropdownKeyDown
		}, open && dropdownFooter ? dropdownFooter : null),
		expandToViewport,
		loopFocus,
		content: open && dropdownContent ? import_react.createElement("div", {
			ref: dropdownContentRef,
			className: styles_css_default$1["dropdown-content"]
		}, dropdownContent) : null
	}));
});
//#endregion
//#region node_modules/@cloudscape-design/components/autosuggest/load-more-controller.js
var useAutosuggestLoadMore = ({ options = [], statusType, onLoadItems }) => {
	...
	const fireLoadMoreOnScroll = () => {
		if (options.length > 0 && statusType === "pending") fireLoadMore({
			firstPage: false,
			samePage: false
		});
	};
...
//#endregion
//#region node_modules/@cloudscape-design/components/autosuggest/utils/utils.js
var isGroup$1 = (option) => (option === null || option === void 0 ? void 0 : option.type) === "parent";
var popLastGroup = (options) => {
	if (options.length) {
		const lastOption = options[options.length - 1];
		if (isGroup$1(lastOption)) options.pop();
	}
};
var filterOptions = (options, text) => {
	const filteredOptions = options.reduce((filteredIn, option) => {
		...
		} else if (matchSingleOption(option, text)) filteredIn.push(option);
		return filteredIn;
	}, []);
...
//#endregion
//#region node_modules/@cloudscape-design/components/autosuggest/options-controller.js
...
var useAutosuggestItems = ({ options, filterValue, filterText, filteringType, enteredTextLabel, hideEnteredTextLabel, onSelectItem }) => {
	...
	const { items, getItemGroup, getItemParent } = (0, import_react.useMemo)(() => createItems(options), [options]);
	...
	if (!enteredItemLabel) warnOnce("Autosuggest", "A value for enteredTextLabel must be provided.");
	const filteredItems = (0, import_react.useMemo)(() => {
		...
		if (filterValue && !hideEnteredTextLabel) filteredItems.unshift({
			value: filterValue,
			type: "use-entered",
	...
	const selectHighlightedOptionWithKeyboard = () => {
		var _a;
		if (highlightedOptionState.highlightedOption && !isInteractive(highlightedOptionState.highlightedOption)) return false;
	...
	const highlightVisibleOptionWithMouse = (index) => {
		if (filteredItems[index] && isHighlightable(filteredItems[index])) highlightedOptionHandlers.setHighlightedIndexWithMouse(index);
	};
	const selectVisibleOptionWithMouse = (index) => {
		if (filteredItems[index] && isInteractive(filteredItems[index])) onSelectItem(filteredItems[index]);
	};
	return [{
...
//#endregion
//#region node_modules/@cloudscape-design/components/autosuggest/styles.css.js
...
//#endregion
//#region node_modules/@cloudscape-design/components/autosuggest/autosuggest-option.js
var toAutosuggestOptionGroupItem = (props) => {
	var _a;
	return {
		type: "group",
...
var toAutosuggestOptionItem = (props) => {
	var _a;
	return {
		type: "item",
		index: (_a = props.virtualIndex) !== null && _a !== void 0 ? _a : props.index,
		...
		disabled: props.disabled,
		parent: props.parentProps ? toAutosuggestOptionGroupItem({
...
var toAutosuggestUseEnteredItem = (props) => {
	return {
		type: "entered-text",
		option: props.option.option,
		highlighted: props.highlighted
...
var AutosuggestOption = ({ index, virtualIndex, nativeAttributes = {}, highlightText, option, highlighted, highlightType, current, virtualPosition, padBottom, screenReaderContent, ariaSetsize, ariaPosinset, renderOption, parentProps, ...rest }, ref) => {
	...
	const getAutosuggestItemProps = (option) => {
		if (option.type === "parent") return toAutosuggestOptionGroupItem({
			option,
			index,
			virtualIndex,
			disabled: !!option.disabled
		});
		else if (option.type === "use-entered") return toAutosuggestUseEnteredItem({
			option,
			highlighted
		});
		else return toAutosuggestOptionItem({
			option,
			index,
			virtualIndex,
			disabled: !!option.disabled,
	...
	const renderOptionWrapper = (option) => {
		...
		return renderOption({
			item: getAutosuggestItemProps(option),
	...
	} else if (isParent) optionContent = renderResult !== null && renderResult !== void 0 ? renderResult : option.label;
	else {
		const a11yProperties = {};
		if (nativeAttributes["aria-label"]) a11yProperties["aria-label"] = nativeAttributes["aria-label"];
		optionContent = import_react.createElement("div", { ...a11yProperties }, import_react.createElement(Option, {
	...
	return import_react.createElement(selectable_item_default, {
		...
		className: styles_css_default.option,
...
var autosuggest_option_default = import_react.memo(import_react.forwardRef(AutosuggestOption));
//#endregion
//#region node_modules/@cloudscape-design/components/autosuggest/utils/parent-props.js
/**
...
*/
var getParentProps = (item, index, lastGroupIndex, virtualIndex) => {
	let updatedLastGroupIndex = lastGroupIndex;
	let parentProps = void 0;
	if (item.type === "parent") updatedLastGroupIndex = index;
	else if (lastGroupIndex !== -1 && !!item.parent) parentProps = {
	...
	return {
		parentProps,
		updatedLastGroupIndex
	};
};
//#endregion
//#region node_modules/@cloudscape-design/components/autosuggest/plain-list.js
var getOptionProps = (index, item, filteredItems, highlightedA11yProps, highlightedOption, hasDropdownStatus) => {
	...
	return {
		nativeAttributes,
		padBottom: !hasDropdownStatus && isNotEnteredTextItem && isLastItem,
		...baseOptionProps
	};
};
var PlainList = ({ autosuggestItemsState, handleLoadMore, menuProps, highlightedA11yProps, hasDropdownStatus, highlightText, listBottom, screenReaderContent, renderOption }) => {
	...
	(0, import_react.useEffect)(() => {
		...
		if (autosuggestItemsState.highlightType.moveFocus && item) scrollElementIntoView(item);
	...
	return import_react.createElement(options_list_default, {
		...
		return import_react.createElement(autosuggest_option_default, {
			index,
			parentProps,
			renderOption,
			highlightText,
		...
		role: "option",
		className: styles_css_default["list-bottom"]
	}, listBottom) : null);
};
//#endregion
//#region node_modules/@cloudscape-design/components/autosuggest/virtual-list.js
var VirtualList = ({ autosuggestItemsState, handleLoadMore, menuProps, highlightedA11yProps, hasDropdownStatus, highlightText, listBottom, screenReaderContent, renderOption }) => {
	const scrollRef = (0, import_react.useRef)(null);
	const [width, strutRef] = useContainerQuery((rect) => rect.contentBoxWidth, []);
	(0, import_react.useImperativeHandle)(strutRef, () => scrollRef.current);
	const rowVirtualizer = useVirtual({
		items: autosuggestItemsState.items,
		parentRef: scrollRef,
		estimateSize: (0, import_react.useCallback)(() => 31, [width, highlightText])
	});
	(0, import_react.useEffect)(() => {
		if (autosuggestItemsState.highlightType.moveFocus) rowVirtualizer.scrollToIndex(autosuggestItemsState.highlightedIndex);
	}, [
	...
	return import_react.createElement(options_list_default, {
		...
		"aria-hidden": "true",
		key: "total-size",
		className: styles_css_default["layout-strut"],
...
//#endregion
//#region node_modules/@cloudscape-design/components/autosuggest/options-list.js
var createMouseEventHandler = (handler) => (itemIndex) => {
	if (itemIndex > -1) handler(itemIndex);
};
function AutosuggestOptionsList({ statusType, autosuggestItemsState, autosuggestItemsHandlers, highlightedOptionId, highlightText, listId, controlId, handleLoadMore, hasDropdownStatus, virtualScroll, selectedAriaLabel, renderHighlightedAriaLive, listBottom, ariaDescribedby, renderOption }) {
	var _a;
	...
	return import_react.createElement(ListComponent, {
		renderOption,
		listBottom,
		handleLoadMore,
...
//#endregion
//#region node_modules/@cloudscape-design/components/autosuggest/internal.js
var InternalAutosuggest = import_react.forwardRef((props, ref) => {
	var _a, _b;
	...
	if (restProps.recoveryText && !onLoadItems) warnOnce("Autosuggest", "`onLoadItems` must be provided for `recoveryText` to be displayed.");
	const [autosuggestItemsState, autosuggestItemsHandlers] = useAutosuggestItems({
		...
		onSelectItem: (option) => {
			...
			(_a = autosuggestInputRef.current) === null || _a === void 0 || _a.close();
		}
	});
	...
	const filteredText = !!value && value.length !== 0 && !(filteringType === "auto" && autosuggestItemsState.showAll) ? filteringResultsText === null || filteringResultsText === void 0 ? void 0 : filteringResultsText(autosuggestItemsState.items.length, (_b = options === null || options === void 0 ? void 0 : options.length) !== null && _b !== void 0 ? _b : 0) : void 0;
	...
	const hasItems = (0, import_react.useRef)(autosuggestItemsState.items.length > 0);
	hasItems.current = hasItems.current || autosuggestItemsState.items.length > 0;
	return import_react.createElement(AutosuggestInput, {
		...restProps,
		className: clsx(styles_css_default.root, restProps.className),
		...
		style,
		dropdownContent: shouldRenderDropdownContent && import_react.createElement(AutosuggestOptionsList, {
			renderOption,
			statusType,
			autosuggestItemsState,
			...
			ariaDescribedby: dropdownStatus.content ? footerControlId : void 0
		}),
		dropdownFooter: dropdownStatus.isSticky && dropdownStatus.content ? import_react.createElement(DropdownFooter, {
			id: footerControlId,
			content: dropdownStatus.content,
...
//#endregion
export { styles_css_default as a, useAutosuggestLoadMore as c, PlainList as i, AutosuggestInput as l, AutosuggestOptionsList as n, useAutosuggestItems as o, VirtualList as r, filterOptions as s, InternalAutosuggest as t, useIMEComposition as u };

//# sourceMappingURL=internal-BZEKgHs2.js.map