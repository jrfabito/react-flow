...
import { d as clsx, i as useBaseComponent, n as getBaseProps, r as applyDisplayName, x as warnOnce } from "./base-component-DsNr9y5n.js";
import { H as useHiddenDescription, b as focus_lock_default, g as InternalTooltip, m as InternalButton, t as InternalAlert } from "./internal-BFDwwSr6.js";
import { t as useMergeRefs } from "./use-merge-refs-Cw10L7Fv.js";
import { n as useUniqueId } from "./use-unique-id-BoAZRjCB.js";
import { t as processAttributes } from "./with-native-attributes-BTfK0ncD.js";
...
import { a as addDays$1, i as addMonths, n as getTimezoneOffsetInMilliseconds, r as add, t as startOfDay } from "./startOfDay-sUUfye-p.js";
import { a as isValid, i as parseISO, n as formatTimeOffsetISO, r as formatTimeOffsetISOInternal, t as formatDateLocalized } from "./format-date-localized-Bd-Pl-rp.js";
import { t as padLeftZeros } from "./pad-left-zeros-E5m_97eE.js";
...
import { t as internal_default$1 } from "./internal-CAd5th-F.js";
import { f as button_trigger_default } from "./use-select-B3C0ZUmT.js";
import { t as InternalSelect } from "./internal-ftxlZnHk.js";
import { t as InternalRadioGroup } from "./internal-C50uBTGK.js";
import { t as InternalSegmentedControl } from "./internal-DOmHPP9l.js";
import "/Users/jrfabito/Documents/Job Search/react-flow/node_modules/@cloudscape-design/components/date-input/styles.scoped.css";
import "/Users/jrfabito/Documents/Job Search/react-flow/node_modules/@cloudscape-design/components/date-range-picker/test-classes/styles.scoped.css";
import "/Users/jrfabito/Documents/Job Search/react-flow/node_modules/@cloudscape-design/components/date-range-picker/calendar/grids/styles.scoped.css";
import "/Users/jrfabito/Documents/Job Search/react-flow/node_modules/@cloudscape-design/components/date-range-picker/styles.scoped.css";
import "/Users/jrfabito/Documents/Job Search/react-flow/node_modules/@cloudscape-design/components/time-input/styles.scoped.css";
import "/Users/jrfabito/Documents/Job Search/react-flow/node_modules/@cloudscape-design/components/date-range-picker/relative-range/styles.scoped.css";
//#region node_modules/@cloudscape-design/components/internal/utils/date-time/display-format.js
/**
...
function addMinutes(dirtyDate, dirtyAmount) {
	requiredArgs(2, arguments);
	return addMilliseconds(dirtyDate, toInteger(dirtyAmount) * MILLISECONDS_IN_MINUTE);
}
//#endregion
...
//#endregion
//#region node_modules/@cloudscape-design/components/internal/utils/date-time/format-date-iso.js
function format_date_iso_default({ date: isoDate, hideTimeOffset, isDateOnly, timeOffset, isMonthOnly }) {
	...
	if (isMonthOnly) return format(parseISO(isoDate), "yyyy-MM");
	return isoDate + formattedOffset;
}
//#endregion
//#region node_modules/@cloudscape-design/components/internal/utils/date-time/is-iso-only.js
...
//#endregion
//#region node_modules/@cloudscape-design/components/internal/utils/date-time/format-date-time-with-offset.js
function formatDateTimeWithOffset({ date, format, hideTimeOffset, timeOffset, locale }) {
	const isDateOnly = isIsoDateOnly(date);
	const isMonthOnly = isIsoMonthOnly(date);
	switch (format) {
		case "long-localized": return formatDateLocalized({
			date,
			hideTimeOffset,
			isDateOnly,
			isMonthOnly,
		...
		case "slashed": {
			const formatted = format_date_iso_default({
				date,
				hideTimeOffset,
				isDateOnly,
				isMonthOnly,
		...
		default: return format_date_iso_default({
			date,
			hideTimeOffset,
			isDateOnly,
			isMonthOnly,
...
//#endregion
//#region node_modules/@cloudscape-design/components/internal/utils/date-time/format-time.js
/**
* Transforms Date's object time part to a string.
*/
var formatTime = (value) => {
	return `${padLeftZeros(`${value.getHours()}`, 2)}:${padLeftZeros(`${value.getMinutes()}`, 2)}:${padLeftZeros(`${value.getSeconds()}`, 2)}`;
};
//#endregion
//#region node_modules/@cloudscape-design/components/internal/utils/date-time/format-date-time.js
function formatDateTime(date) {
	return formatDate(date) + "T" + formatTime(date);
}
//#endregion
//#region node_modules/@cloudscape-design/components/internal/utils/date-time/join-date-time.js
...
//#endregion
//#region node_modules/@cloudscape-design/components/internal/utils/date-time/parse-date.js
...
//#endregion
//#region node_modules/@cloudscape-design/components/internal/utils/date-time/parse-timezone-offset.js
/**
...
function parseTimezoneOffset(isoDate) {
	...
	if (isoDate.indexOf("Z") !== -1) return 0;
	return 0 - new Date(isoDate).getTimezoneOffset();
}
//#endregion
//#region node_modules/@cloudscape-design/components/internal/utils/date-time/shift-timezone-offset.js
/**
...
//#endregion
//#region node_modules/@cloudscape-design/components/internal/hooks/use-date-cache/index.js
...
//#endregion
//#region node_modules/@cloudscape-design/components/internal/utils/locale/merge-locales.js
function mergeLocales(locale, fullLocale) {
	if (locale.length === 2 && fullLocale.indexOf(locale) === 0) return fullLocale;
	return locale;
}
//#endregion
//#region node_modules/@cloudscape-design/components/internal/utils/locale/normalize-locale.js
function normalizeLocale(component, locale) {
	var _a;
	locale = checkLocale(component, locale);
	const browserLocale = getBrowserLocale();
	if (locale) return mergeLocales(locale, browserLocale);
	const htmlLocale = checkLocale(component, (_a = getHtmlElement()) === null || _a === void 0 ? void 0 : _a.getAttribute("lang"));
	if (htmlLocale) return mergeLocales(htmlLocale, browserLocale);
...
//#endregion
//#region node_modules/weekstart/dist/es-module/api.js
...
//#endregion
//#region node_modules/weekstart/dist/es-module/langRegionMap.js
var langRegionMap = {
	en: "US",
	zh: "CN",
	zh_hans: "CN",
...
//#endregion
//#region node_modules/weekstart/dist/es-module/regionDayMap.js
var regionDayMap = {
	AG: 0,
	ATG: 0,
	28: 0,
...
//#endregion
//#region node_modules/weekstart/dist/es-module/main.js
function getWeekStartByLocale$1(locale) {
	return getWeekStartByLocale(locale, langRegionMap, regionDayMap);
}
//#endregion
//#region node_modules/@cloudscape-design/components/internal/utils/locale/normalize-start-of-week.js
function normalizeStartOfWeek(startOfWeek, locale) {
	return typeof startOfWeek === "number" ? startOfWeek % 7 : getWeekStartByLocale$1(locale);
}
//#endregion
//#region node_modules/@cloudscape-design/components/calendar/utils/intl.js
function setDayIndex$1(date, dayIndex) {
	const diff = dayIndex - date.getDay();
	date.setDate(date.getDate() + diff);
}
function renderDayName$1(locale, dayIndex, mode) {
	const tempDate = /* @__PURE__ */ new Date();
	setDayIndex$1(tempDate, dayIndex);
	return tempDate.toLocaleDateString(locale, { weekday: mode });
}
function renderMonthAndYear$1(locale, baseDate) {
	return baseDate.toLocaleDateString(locale, {
		year: "numeric",
		month: "long"
	});
}
function renderYear(locale, date) {
	return date.toLocaleDateString(locale, { year: "numeric" });
}
var dayLabelCache$1 = /* @__PURE__ */ new Map();
function getDateLabel$1(locale, date, mode = "full") {
	const cacheKey = locale + date.getTime() + mode;
	const cachedValue = dayLabelCache$1.get(cacheKey);
	...
	dayLabelCache$1.set(cacheKey, value);
	return value;
}
function renderTimeLabel(locale, date, format) {
	let options = {};
	if (format === "hh") options = { hour: "2-digit" };
	if (format === "hh:mm") options = {
		hour: "2-digit",
		minute: "2-digit"
	};
...
//#endregion
//#region node_modules/@cloudscape-design/components/calendar/utils/navigation-day.js
...
function getBaseDay(date, isDateFocusable) {
	const startDate = startOfMonth(date);
	if (isDateFocusable(startDate)) return startDate;
...
function moveDay(startDate, isDateFocusable, step) {
	const limitYears = 1;
	let current = addDays$1(startDate, step);
	while (!isDateFocusable(current)) {
		if (Math.abs(differenceInYears(startDate, current)) > limitYears) return startDate;
		current = addDays$1(current, step);
	}
	return current;
}
//#endregion
//#region node_modules/@cloudscape-design/components/calendar/utils/navigation-month.js
...
function getBaseMonth(date, isDateFocusable) {
...
//#endregion
//#region node_modules/mnth/web/add-days.js
...
//#endregion
//#region node_modules/mnth/web/set-date.js
...
//#endregion
//#region node_modules/mnth/web/index.js
...
var getCalendarMonth = function getCalendarMonth(date, options) {
	var firstDayOfWeek = _objectSpread({ firstDayOfWeek: 1 }, options).firstDayOfWeek;
	...
	for (var i = 1 - daysToPrepend; i <= daysInMonth + daysToAppend + 1; i++) {
		if (i <= 0) week.push(addDays(firstDateOfMonth, i - 1));
		else if (i > daysInMonth) week.push(addDays(lastDateOfMonth, i - daysInMonth));
		else week.push(setDate(date, i));
		if (week.length === 7) {
			month.push(week);
			week = [];
		}
...
//#endregion
//#region node_modules/@cloudscape-design/components/internal/utils/date-time/calendar.js
...
var MonthCalendar = class {
	constructor({ padDates, baseDate, startOfWeek, selection }) {
		...
		const isDateVisible = (weekIndex, dayIndex) => {
			...
			switch (padDates) {
				case "before": return isSameMonth(date, baseDate) || isBefore(date, baseDate);
				case "after": return isSameMonth(date, baseDate) || isAfter(date, baseDate);
			}
		};
		...
		const getWeekTestIndex = (weekIndex) => {
			...
			const week = allCalendarDates[weekIndex];
			if (!week) return;
			if (!isSameMonth(week[0], baseDate) && !isSameMonth(week[week.length - 1], baseDate)) return;
...
function getCalendarMonthWithSixRows(date, { startOfWeek, padDates }) {
	switch (padDates) {
		case "before": return [...getPrevMonthRows(date, startOfWeek), ...getCurrentMonthRows(date, startOfWeek)].slice(-6);
		case "after": return [...getCurrentMonthRows(date, startOfWeek), ...getNextMonthRows(date, startOfWeek)].slice(0, 6);
	}
}
function checkDateIsInRange(date, dateOne, dateTwo) {
	if (!dateOne || !dateTwo || isSameDay(dateOne, dateTwo)) return false;
	return isAfter(date, dateOne) && isBefore(date, dateTwo) || isAfter(date, dateTwo) && isBefore(date, dateOne) || isSameDay(date, dateOne) || isSameDay(date, dateTwo);
}
function checkMonthIsInRange(date, dateOne, dateTwo) {
	if (!dateOne || !dateTwo || isSameMonth(dateOne, dateTwo)) return false;
	return isAfter(date, dateOne) && isBefore(date, dateTwo) || isAfter(date, dateTwo) && isBefore(date, dateOne) || isSameMonth(date, dateOne) || isSameMonth(date, dateTwo);
}
...
//#endregion
//#region node_modules/@cloudscape-design/components/internal/components/masked-input/keyboard-handler.js
/**
...
var backspaceHandler = (initialValue, format, selectionStart, selectionEnd) => {
	if (selectionStart !== selectionEnd) {
		if (!(selectionEnd === initialValue.length)) return format.replaceDigitsWithZeroes(initialValue, selectionStart, selectionEnd);
		return {
	...
	if (!(selectionStart === initialValue.length)) if (isSeparator) return format.deleteSeparator(initialValue, selectionStart);
	else return format.deleteDigit(initialValue, selectionStart);
...
var keyHandler = (initialValue, key, format, selectionStart, selectionEnd) => {
	...
	if (selectionStart === value.length && value.length === format.getMaxLength()) return {
		value,
		position
	};
	...
	if (format.isCursorAtSeparator(position)) return {
		value,
		position: position + 1
	};
...
//#endregion
//#region node_modules/@cloudscape-design/components/internal/components/masked-input/utils/keys.js
...
//#endregion
//#region node_modules/@cloudscape-design/components/internal/components/masked-input/use-mask.js
var onAutoComplete = (value, onChange, maskFormat) => {
	if (!value) return;
	const autoCompletedValue = maskFormat.autoComplete(value);
	if (autoCompletedValue !== value) onChange(autoCompletedValue);
};
var preventDefault = (event, result) => result && event.preventDefault();
var useMask = ({ value = "", onBlur, onChange, onKeyDown, format, inputRef, autofix = false, disableAutocompleteOnBlur = false, setPosition, showUnmaskedValue = false }) => {
	if (!format.isValid(value) && !showUnmaskedValue) warnOnce("useMask", `Invalid string "${value}" provided`);
	const onMaskChange = (updatedValue) => {
		const autofixedUpdatedValue = autofix ? format.correctMinMaxValues(updatedValue) : updatedValue;
		if (autofixedUpdatedValue === value || !format.isValid(autofixedUpdatedValue)) return;
	...
	return {
		...
		onKeyDown: (event) => {
			...
			if (isDigit(key) || format.isSeparator(key)) {
				...
				preventDefault(event, result);
			} else if (keyCode === KeyCode.enter) result = enterHandler(maskedValue, format);
			else if (!isCommand(keyCode, ctrlKey, metaKey)) event.preventDefault();
			if (result) {
		...
		onBlur: () => {
			if (!disableAutocompleteOnBlur) onAutoComplete(maskedValue, onChange, format);
		...
		onPaste: (event) => {
			...
			if (event.clipboardData) {
				...
				const selectionStart = ((_a = inputRef.current) === null || _a === void 0 ? void 0 : _a.selectionStart) || 0;
				const selectionEnd = ((_b = inputRef.current) === null || _b === void 0 ? void 0 : _b.selectionEnd) || 0;
				onMaskChange(format.formatPastedText(text, maskedValue, selectionStart, selectionEnd));
			}
		}
	};
};
//#endregion
//#region node_modules/@cloudscape-design/components/internal/components/masked-input/utils/strings.js
var insertAt = (text, toInsert, start, end = start) => text.slice(0, start) + toInsert + text.slice(end);
//#endregion
//#region node_modules/@cloudscape-design/components/internal/components/masked-input/utils/mask-format.js
var MaskFormat = class {
	...
	isValid(value) {
		...
		if (inputSegments.length > this.segments.length) return false;
		return inputSegments.every((segmentValue, i) => {
			const segment = this.segments[i];
			if (segmentValue === "") if (i === inputSegments.length - 1) return true;
			else return false;
			if (!segmentValue.match(/^\d+$/)) return false;
			if (segmentValue.length < segment.length && i !== inputSegments.length - 1) return false;
			const intValue = parseInt(segmentValue, 10);
			if (segmentValue.length > segment.length) return false;
			if (intValue < segment.min || intValue > segment.max(value)) {
				if (i === inputSegments.length - 1 && segmentValue.length < segment.length) return true;
				return false;
			}
			return true;
		});
	...
	getValidValue(value) {
		...
		do {
			if (this.isValid(validValue)) return this.tryAppendSeparator(validValue);
	...
	replaceDigitsWithZeroes(value, cursorStart, cursorEnd) {
		...
		if (this.isCursorAtSeparator(cursorStart)) cursorStart++;
	...
	deleteDigit(value, position) {
		...
		if (value.slice(length - 2) === "0:") value = value.slice(0, length - 2);
		return {
			value: this.correctMinMaxValues(value),
			position: position - 1
		};
	...
	correctMinMaxValues(value) {
		...
		while (segment && value.length >= segment.end) {
			...
			if (segmentValue > segmentMax) value = insertAt(value, segmentMax.toFixed(), segment.start, segment.end);
	...
	formatPastedText(text, value, cursorStart, cursorEnd) {
		...
		if (cursorEnd > cursorStart && cursorEnd === value.length) formattedValue = value.slice(0, cursorStart);
	...
	processKey(initialValue, key, initialPosition) {
		...
		if (this.isSeparator(key)) {
			...
			if (this.isSegmentStart(position) && isValidPosition && firstDigitGreater) {
		...
		if (this.isCursorAtSeparator(position)) position++;
		return {
			value,
			position
		};
	...
	enrichSegmentDefinitions(segments) {
		...
		for (const segment of segments) {
			...
			for (let j = 0; j < fullSegment.length; j++) this.positionFormats.set(position++, fullSegment);
			position++;
		}
	}
};
//#endregion
//#region node_modules/@cloudscape-design/components/internal/components/masked-input/index.js
var MaskedInput = import_react.forwardRef(({ value, onBlur, onChange, onKeyDown, mask, autofix = false, disableAutocompleteOnBlur = false, showUnmaskedValue = false, nativeInputAttributes, ...rest }, ref) => {
	...
	(0, import_react.useLayoutEffect)(() => {
		var _a;
		if (cursorPosition !== null) (_a = inputRef.current) === null || _a === void 0 || _a.setSelectionRange(cursorPosition, cursorPosition);
	...
	return import_react.createElement(internal_default$1, {
		...inputProps,
		ref: mergedRef,
		nativeInputAttributes: processAttributes({ onPaste }, nativeInputAttributes, "MaskedInput")
	});
});
//#endregion
//#region node_modules/@cloudscape-design/components/date-input/utils.js
var yearMask = {
	min: 0,
	max: 9999,
	default: 2e3,
...
var dayMask = {
	min: 1,
	max: getMaxDaysForDate,
	length: 2
};
function getMaxDaysForDate(value) {
	return getDaysInMonth(parseDate(displayToIso(value).substring(0, 7)));
}
var generateMaskArgs = ({ granularity = "day", isIso = false } = {}) => {
	return {
		separator: isIso ? "-" : "/",
		...
		segments: granularity === "month" ? [yearMask, monthMask] : [
			yearMask,
			monthMask,
			dayMask
		]
...
function normalizeIsoDateString(dateString, granularity) {
	...
	if (granularity === "day" && (month === null || month === void 0 ? void 0 : month.length) === 2 && (day === null || day === void 0 ? void 0 : day.length) === 2) return `${year}-${month}-${day}`;
	if ((month === null || month === void 0 ? void 0 : month.length) === 2) return `${year}-${month}`;
	return year;
}
//#endregion
//#region node_modules/@cloudscape-design/components/date-input/styles.css.js
var styles_css_default$5 = { "root": "awsui_root_yodkx_im8v7_5" };
//#endregion
//#region node_modules/@cloudscape-design/components/date-input/internal.js
var InternalDateInput = import_react.forwardRef(({ value, onChange, onBlur, onFocus, granularity = "day", locale, format = "slashed", inputFormat = "slashed", __internalRootRef, __injectAnalyticsComponentMetadata = false, ...props }, ref) => {
	...
	const onInputChange = (event) => {
		if (!(format === "long-localized" && !(isFocused || props.readOnly))) fireNonCancelableEvent(onChange, { value: displayToIso(event.detail.value) });
	};
	const usesLongLocalizedValue = format === "long-localized" && !(isFocused && !props.readOnly);
	const displayedValue = (0, import_react.useMemo)(() => {
		if (!value) return "";
		...
		if (usesLongLocalizedValue && normalizedValue) return formatDateLocalized({
			date: normalizedValue,
			...formatProps
		});
		if (isIso) return normalizedValue === isoValue ? format_date_iso_default({
			date: normalizedValue,
			...formatProps
		}) : isoValue;
	...
	return import_react.createElement(MaskedInput, {
		ref: inputRef,
		...props,
		...
		onBlur: onInputBlur,
		className: clsx(styles_css_default$5.root, props.className),
		mask: generateMaskArgs({
			granularity,
			isIso
		}),
...
//#endregion
//#region node_modules/@cloudscape-design/components/internal/focus-tracker.js
var FocusTracker = class {
	constructor(node, { onFocusEnter, onFocusLeave }) {
		...
		this.focusInListener = (event) => {
			...
			if (!this.currentlyFocused && focusIsInside) this.triggerFocus();
		};
		this.focusOutListener = (event) => {
			const nextFocused = event.relatedTarget;
			const isNextFocusedInParent = !nodeBelongs(this.node, nextFocused);
			if (this.currentlyFocused && (nextFocused === null || isNextFocusedInParent)) this.triggerBlur();
		};
...
//#endregion
//#region node_modules/@cloudscape-design/components/internal/hooks/use-focus-tracker.js
var useFocusTracker = ({ rootRef, onBlur, onFocus }) => {
	const focusTracker = (0, import_react.useRef)(null);
	(0, import_react.useEffect)(() => {
		...
		return () => {
			var _a;
			(_a = focusTracker.current) === null || _a === void 0 || _a.destroy();
		};
	}, [
		rootRef,
		onBlur,
...
//#endregion
//#region node_modules/@cloudscape-design/components/internal/utils/has-value.js
function hasValue(value) {
	return value !== null && value !== void 0;
}
//#endregion
//#region node_modules/@cloudscape-design/components/date-range-picker/calendar/utils.js
function isVisibleMonth(dateLeft, dateRight, isSingleGrid) {
	if (isSingleGrid) return isSameMonth(dateLeft, dateRight);
...
function isVisibleYear(dateLeft, dateRight, isSingleGrid) {
	if (isSingleGrid) return isSameYear(dateLeft, dateRight);
	return isSameYear(dateLeft, dateRight) || isSameYear(dateLeft, addYears(dateRight, 1));
}
function findDateToFocus(selected, baseDate, isDateEnabled, isSingleGrid) {
	if (selected && isDateEnabled(selected) && isVisibleMonth(selected, baseDate, isSingleGrid)) return selected;
	const today = /* @__PURE__ */ new Date();
	if (isDateEnabled(today) && isVisibleMonth(today, baseDate, isSingleGrid)) return today;
	if (isDateEnabled(baseDate)) return baseDate;
	return null;
}
function findMonthToFocus(selected, baseDate, isMonthEnabled, isSingleGrid) {
	if (selected && isMonthEnabled(selected) && isVisibleYear(selected, baseDate, isSingleGrid)) return selected;
	const today = /* @__PURE__ */ new Date();
	if (isMonthEnabled(today) && isVisibleYear(today, baseDate, isSingleGrid)) return today;
	if (isMonthEnabled(baseDate)) return baseDate;
	return null;
}
function calculateEffectiveStartPeriod(startPeriod, value, isSamePeriod) {
	if (startPeriod === "current") return "current";
	if ((value.start.date || value.end.date) && startPeriod === "auto") return "current";
	if (value.start.date && value.end.date) {
		if (!isSamePeriod(parseDate(value.start.date), parseDate(value.end.date))) return "current";
	}
	return "previous";
}
function calculateDisplayOffset(isSingleGrid, startPeriod) {
	if (isSingleGrid) return 0;
...
function findPeriodToDisplay(value, isSingleGrid, startPeriod, addPeriods, startOfPeriod, isSamePeriod) {
	const offset = calculateDisplayOffset(isSingleGrid, calculateEffectiveStartPeriod(startPeriod, value, isSamePeriod));
	return startOfPeriod(addPeriods(value.start.date && parseDate(value.start.date) || value.end.date && parseDate(value.end.date) || Date.now(), offset));
}
function findMonthToDisplay(value, isSingleGrid, startPeriod) {
	return findPeriodToDisplay(value, isSingleGrid, startPeriod, addMonths, startOfMonth, isSameMonth);
}
function findYearToDisplay(value, isSingleGrid, startPeriod) {
...
var generateI18NFallbackKey = (isMonthPicker, isDateOnly) => {
	if (isMonthPicker) return "i18nStrings.monthConstraintText";
	if (isDateOnly) return "i18nStrings.dateConstraintText";
	return "i18nStrings.dateTimeConstraintText";
};
var generateI18NKey = (isMonthPicker, isDateOnly, isIso) => {
	if (isMonthPicker) return isIso ? "i18nStrings.isoMonthConstraintText" : "i18nStrings.slashedMonthConstraintText";
	if (isDateOnly) return isIso ? "i18nStrings.isoDateConstraintText" : "i18nStrings.slashedDateConstraintText";
...
var provideI18N = (i18nStrings, isMonthPicker, isDateOnly, isIso) => {
	...
	if (isMonthPicker) {
		...
		if (!result) result = i18nStrings === null || i18nStrings === void 0 ? void 0 : i18nStrings.monthConstraintText;
	} else if (isDateOnly) {
		...
		if (!result) result = i18nStrings === null || i18nStrings === void 0 ? void 0 : i18nStrings.dateConstraintText;
	}
	if (!result) {
		...
		if (!result) result = i18nStrings === null || i18nStrings === void 0 ? void 0 : i18nStrings.dateTimeConstraintText;
	}
	return result;
};
//#endregion
//#region node_modules/@cloudscape-design/components/date-range-picker/test-classes/styles.css.js
...
//#endregion
//#region node_modules/@cloudscape-design/components/date-range-picker/calendar/grids/grid-cell.js
var GridCell = (0, import_react.forwardRef)((props, focusedDateRef) => {
	...
	return import_react.createElement("td", {
		...
		className: styles_css_default$4["disabled-reason-tooltip"],
...
//#endregion
//#region node_modules/@cloudscape-design/components/date-range-picker/calendar/grids/intl.js
...
function renderDateAnnouncement({ date, isCurrent, locale, granularity = "day", currentLabel }) {
	const formattedDate = granularity === "month" ? renderMonthAndYear(locale, date) : getDateLabel(locale, date, "short");
	if (isCurrent && currentLabel) return `${formattedDate}. ${currentLabel}`;
	return formattedDate;
}
//#endregion
//#region node_modules/@cloudscape-design/components/date-range-picker/calendar/grids/styles.css.js
...
//#endregion
//#region node_modules/@cloudscape-design/components/date-range-picker/calendar/grids/grid.js
var dayUtils = {
...
*/
function Grid({ padDates, baseDate, selectedStartDate, selectedEndDate, rangeStartDate, rangeEndDate, focusedDate, focusedDateRef, onSelectDate, onGridKeyDownHandler, onFocusedDateChange, isDateEnabled, dateDisabledReason, locale, todayAriaLabel, currentMonthAriaLabel, ariaLabelledby, className, startOfWeek: rawStartOfWeek = 0, granularity = "day", referrerId }) {
	...
	return import_react.createElement("table", {
		...
		className: clsx(styles_css_default$3.grid, className)
	}, !isMonthPicker && import_react.createElement("thead", null, import_react.createElement("tr", null, calendar.header.map((dayIndex) => import_react.createElement("th", {
		key: dayIndex,
		scope: "col",
		className: clsx(styles_css_default$3["grid-cell"], styles_css_default$3["day-header"], styles_css_default$4["day-header"])
	}, import_react.createElement("span", { "aria-hidden": "true" }, renderDayName(locale, dayIndex, "short")), import_react.createElement(ScreenreaderOnly, null, renderDayName(locale, dayIndex, "long")))))), import_react.createElement("tbody", { onKeyDown: onGridKeyDownHandler }, calendar.rows.map((row, rowIndex) => {
		...
		return import_react.createElement("tr", {
			key: rowIndex,
			className: clsx({
				[styles_css_default$4["calendar-quarter"]]: isMonthPicker,
				[styles_css_default$4["calendar-week"]]: !isMonthPicker
			}),
			...!isMonthPicker && weekTestIndex ? { ["data-awsui-weekindex"]: weekTestIndex } : {}
			...
			const baseClasses = {
				[styles_css_default$4["calendar-date"]]: !isMonthPicker && isSameMonth(date, baseDate),
				[styles_css_default$4["calendar-month"]]: isMonthPicker && isSameYear(date, baseDate),
				[styles_css_default$3.day]: !isMonthPicker,
				[styles_css_default$3.month]: isMonthPicker,
				[styles_css_default$3["grid-cell"]]: true,
				[styles_css_default$3["in-first-row"]]: rowIndex === 0,
				[styles_css_default$3["in-first-column"]]: rowItemIndex === 0
			};
			if (!isVisible) return import_react.createElement("td", {
				key: itemKey,
				ref: isFocused ? focusedDateRef : void 0,
				className: clsx(baseClasses, {
					[styles_css_default$3[`last-day-of-month`]]: !isMonthPicker && isLastDayOfMonth(date),
					[styles_css_default$3[`last-month-of-year`]]: isMonthPicker && date.getMonth() === 11
				})
			});
			const handlers = {};
			if (isEnabled) {
			...
			if (currentAnnouncement) {
				if (isMonthPicker && isThisMonth(date)) announcement += `. ${currentAnnouncement}`;
				else if (!isMonthPicker && isToday(date)) announcement += `. ${currentAnnouncement}`;
			}
			let tabIndex = void 0;
			if (isEnabled || isDisabledWithReason) tabIndex = isFocusable ? 0 : -1;
			return import_react.createElement(GridCell, {
				ref: isFocused ? focusedDateRef : void 0,
				key: itemKey,
				className: clsx(baseClasses, {
					[styles_css_default$3["in-visible-calendar"]]: true,
					[styles_css_default$3[`in-current-${pageName}`]]: isSamePage(date, baseDate),
					[styles_css_default$3.enabled]: isEnabled,
					[styles_css_default$3.selected]: isSelected,
					[styles_css_default$3["start-date"]]: isStartDate,
					[styles_css_default$3["end-date"]]: isEndDate,
					[styles_css_default$4["start-date"]]: isStartDate,
					[styles_css_default$4["end-date"]]: isEndDate,
					[styles_css_default$3["no-range"]]: isSelected && onlyOneSelected,
					[styles_css_default$3["in-range"]]: isInRange,
					[styles_css_default$3["in-range-border-block-start"]]: isSelectionTop,
					[styles_css_default$3["in-range-border-block-end"]]: isSelectionBottom,
					[styles_css_default$3["in-range-border-inline-start"]]: isSelectionLeft,
					[styles_css_default$3["in-range-border-inline-end"]]: isSelectionRight,
					[styles_css_default$3.today]: isCurrentDay,
					[styles_css_default$4.today]: isCurrentDay,
					[styles_css_default$3["this-month"]]: isCurrentMonth,
					[styles_css_default$4["this-month"]]: isCurrentMonth
				}),
				"aria-selected": isEnabled ? isSelected || isInRange : void 0,
				...
				className: styles_css_default$3[`${granularity}-inner`],
				"aria-hidden": "true"
			}, isMonthPicker ? date.toLocaleString(locale, { month: "short" }) : date.getDate()), import_react.createElement(ScreenreaderOnly, null, announcement));
		}));
	})));
}
//#endregion
//#region node_modules/@cloudscape-design/components/date-range-picker/calendar/grids/index.js
function isVisible(date, baseDate, isSingleGrid, granularity) {
	...
	if (isSingleGrid) return isSame(date, baseDate);
	const next = add(baseDate, 1);
	return isSame(date, baseDate) || isSame(date, next);
}
var Grids = ({ baseDate, selectedStartDate, selectedEndDate, focusedDate, onFocusedDateChange, isDateEnabled, dateDisabledReason, isSingleGrid, onSelectDate, onPageChange, locale, todayAriaLabel, currentMonthAriaLabel, headingIdPrefix, startOfWeek = 0, granularity = "day", referrerId }) => {
	const containerRef = (0, import_react.useRef)(null);
	const [gridHasFocus, setGridHasFocus] = (0, import_react.useState)(false);
	const isMonthPicker = granularity === "month";
	...
	const isDateFocusable = (0, import_react.useCallback)((date) => {
	...
	(0, import_react.useEffect)(() => {
		if (focusedDate && !isVisible(focusedDate, baseDate, isSingleGrid, granularity)) {
			...
			const nearestBaseDate = getBase(!isSingleGrid && direction === -1 ? addPages(baseDate, -1) : baseDate, isDateFocusable);
			onFocusedDateChange(findDateToFocus(focusedDate, nearestBaseDate, isDateFocusable, isSingleGrid));
		}
	}, [
		baseDate,
		focusedDate,
	...
	const onGridKeyDownHandler = (event) => {
		...
		if (focusedDate === null || keys.indexOf(event.keyCode) === -1) return;
		event.preventDefault();
		handleKey(event, {
			onActivate: () => {
				if (!focusedDate || !isDateEnabled(focusedDate)) return;
		...
		if (!isVisible(updatedFocusDate, baseDate, isSingleGrid, granularity)) onPageChange(!isSingleGrid && isAfter(updatedFocusDate, baseDate) ? addPages(updatedFocusDate, -1) : updatedFocusDate);
		onFocusedDateChange(updatedFocusDate);
	};
	(0, import_react.useEffect)(() => {
		if (focusedDate !== null && gridHasFocus) {
			if (focusedDateRef.current && focusedDateRef.current !== document.activeElement) focusedDateRef.current.focus();
		}
	...
	const onGridBlur = (event) => {
		...
		if (newFocusTarget && !newFocusTargetIsInGrid && gridHasFocus) setGridHasFocus(false);
	};
	const onGridFocus = () => {
		if (!gridHasFocus) setGridHasFocus(true);
	};
	...
	}, import_react.createElement(Grid, {
		...sharedGridProps,
		padDates: isSingleGrid ? "after" : "before",
		className: styles_css_default$4["first-grid"],
		baseDate,
		ariaLabelledby: `${headingIdPrefix}-prev${pageUnit}`,
		referrerId
	}), !isSingleGrid && import_react.createElement(Grid, {
		...sharedGridProps,
		padDates: "after",
		className: styles_css_default$4["second-grid"],
...
//#endregion
//#region node_modules/@cloudscape-design/components/date-range-picker/calendar/header/header-button.js
function PrevPageButton({ ariaLabel, onChangePage }) {
	return import_react.createElement(InternalButton, {
		...
		formAction: "none",
		className: clsx(styles_css_default$4[`calendar-prev-page-btn`], styles_css_default$4[`calendar-prev-month-btn`])
	});
}
function NextPageButton({ ariaLabel, onChangePage }) {
	return import_react.createElement(InternalButton, {
		...
		onClick: () => onChangePage(1),
		formAction: "none",
		className: clsx(styles_css_default$4[`calendar-next-page-btn`], styles_css_default$4[`calendar-next-month-btn`])
	});
}
//#endregion
//#region node_modules/@cloudscape-design/components/date-range-picker/styles.css.js
...
//#endregion
//#region node_modules/@cloudscape-design/components/date-range-picker/calendar/header/index.js
function CalendarHeader({ baseDate, locale, onChangePage, previousPageLabel, nextPageLabel, isSingleGrid, headingIdPrefix, granularity = "day" }) {
	const i18n = useInternalI18n("date-range-picker");
	const isMonthPicker = granularity === "month";
	const renderLabel = isMonthPicker ? renderYear : renderMonthAndYear$1;
	...
	const pageUnit = isMonthPicker ? "year" : "month";
	return import_react.createElement(import_react.Fragment, null, import_react.createElement("div", { className: clsx(styles_css_default$4["calendar-header"], styles_css_default$2["calendar-header"]) }, import_react.createElement(PrevPageButton, {
		ariaLabel: i18n(isMonthPicker ? "i18nStrings.previousYearAriaLabel" : "i18nStrings.previousMonthAriaLabel", previousPageLabel),
		onChangePage
	}), import_react.createElement("h2", { className: styles_css_default$2["calendar-header-pages-wrapper"] }, import_react.createElement("span", {
		className: styles_css_default$2["calendar-header-page"],
		id: `${headingIdPrefix}-prev${pageUnit}`
	}, firstPageHeaderLabel), !isSingleGrid && import_react.createElement("span", {
		className: styles_css_default$2["calendar-header-page"],
		id: `${headingIdPrefix}-current${pageUnit}`
	}, secondPageHeaderLabel)), import_react.createElement(NextPageButton, {
		ariaLabel: i18n(isMonthPicker ? "i18nStrings.nextYearAriaLabel" : "i18nStrings.nextMonthAriaLabel", nextPageLabel),
		onChangePage
	})), import_react.createElement(internal_default, { hidden: true }, isSingleGrid ? secondPageHeaderLabel : `${firstPageHeaderLabel}, ${secondPageHeaderLabel}`));
}
//#endregion
//#region node_modules/@cloudscape-design/components/time-input/styles.css.js
var styles_css_default$1 = { "root": "awsui_root_l809c_im8v7_5" };
//#endregion
//#region node_modules/@cloudscape-design/components/time-input/internal.js
var getMaskArgs = (format, use24Hour) => {
	return {
		separator: ":",
		segments: [
			use24Hour ? {
...
var InternalTimeInput = import_react.forwardRef(({ format = "hh:mm:ss", use24Hour = true, autoComplete = true, __internalRootRef, ...props }, ref) => {
	const inputRef = (0, import_react.useRef)(null);
	useForwardFocus(ref, inputRef);
	...
	return import_react.createElement(MaskedInput, {
		...
		__internalRootRef,
		ref: inputRef,
		className: clsx(styles_css_default$1.root, props.className),
		autoComplete,
		disableBrowserAutocorrect: true,
		mask: maskArgs
	});
...
//#endregion
//#region node_modules/@cloudscape-design/components/date-range-picker/calendar/range-inputs.js
function RangeInputs({ startDate, onChangeStartDate, startTime, onChangeStartTime, endDate, onChangeEndDate, endTime, onChangeEndTime, i18nStrings, dateOnly, timeInputFormat, dateInputFormat, granularity }) {
	...
	const i18nDatePlaceholder = isIso ? i18n("i18nStrings.isoDatePlaceholder", i18nStrings === null || i18nStrings === void 0 ? void 0 : i18nStrings.isoDatePlaceholder) : i18n("i18nStrings.slashedDatePlaceholder", i18nStrings === null || i18nStrings === void 0 ? void 0 : i18nStrings.slashedDatePlaceholder);
	const datePlaceholder = i18nDatePlaceholder ? isMonthPicker ? i18nDatePlaceholder.split(separator).slice(0, 2).join(separator) : i18nDatePlaceholder : defaultDateInputPlaceholder;
	...
	const timePlaceholder = i18nTimePlaceholder ? i18nTimePlaceholder.split(":").slice(0, timeFormatParts).join(":") : timeInputFormat;
	...
	return import_react.createElement(InternalFormField, { constraintText: i18n(i18nKey, i18nProvided) || i18n(i18nFallbackKey, i18nProvided) }, import_react.createElement("div", { className: styles_css_default$2["date-and-time-container"] }, import_react.createElement("div", { className: styles_css_default$2["date-and-time-wrapper"] }, import_react.createElement(InternalFormField, {
		stretch: true,
		label: i18n(isMonthPicker ? "i18nStrings.startMonthLabel" : "i18nStrings.startDateLabel", isMonthPicker ? i18nStrings === null || i18nStrings === void 0 ? void 0 : i18nStrings.startMonthLabel : i18nStrings === null || i18nStrings === void 0 ? void 0 : i18nStrings.startDateLabel)
	}, import_react.createElement(InternalDateInput, {
		value: startDate,
		className: clsx(styles_css_default$4["start-date-input"], isMonthPicker && styles_css_default$4["start-month-input"]),
		onChange: (event) => onChangeStartDate(event.detail.value),
		format: dateInputFormat,
		placeholder: datePlaceholder,
		granularity
	})), showTimeInput && import_react.createElement(InternalFormField, {
		stretch: true,
		label: i18n("i18nStrings.startTimeLabel", i18nStrings === null || i18nStrings === void 0 ? void 0 : i18nStrings.startTimeLabel)
	}, import_react.createElement(InternalTimeInput, {
		value: startTime,
		onChange: (event) => onChangeStartTime(event.detail.value),
		format: timeInputFormat,
		placeholder: timePlaceholder,
		className: styles_css_default$4["start-time-input"]
	}))), import_react.createElement("div", { className: styles_css_default$2["date-and-time-wrapper"] }, import_react.createElement(InternalFormField, {
		stretch: true,
		label: i18n(isMonthPicker ? "i18nStrings.endMonthLabel" : "i18nStrings.endDateLabel", isMonthPicker ? i18nStrings === null || i18nStrings === void 0 ? void 0 : i18nStrings.endMonthLabel : i18nStrings === null || i18nStrings === void 0 ? void 0 : i18nStrings.endDateLabel)
	}, import_react.createElement(InternalDateInput, {
		value: endDate,
		className: clsx(styles_css_default$4["end-date-input"], isMonthPicker && styles_css_default$4["end-month-picker"]),
		...
		format: timeInputFormat,
		placeholder: timePlaceholder,
		className: styles_css_default$4["end-time-input"]
	})))));
}
//#endregion
//#region node_modules/@cloudscape-design/components/date-range-picker/calendar/index.js
function DateRangePickerCalendar({ value, setValue, locale = "", startOfWeek, isDateEnabled = () => true, dateDisabledReason = () => "", i18nStrings, dateOnly = false, timeInputFormat, dateInputFormat, customAbsoluteRangeControl, granularity = "day", referrerId, multiGridStartPeriod }) {
	var _a, _b;
	...
	const [currentPage, setCurrentPage] = (0, import_react.useState)(() => findPageToDisplay(value, isSingleGrid, multiGridStartPeriod));
	const [focusedDate, setFocusedDate] = (0, import_react.useState)(() => {
		if (value.start.date) {
			const startDate = parseDate(value.start.date);
			if (isSamePage(startDate, currentPage)) return startDate;
			if (!isSingleGrid && isSamePage(startDate, addPage(currentPage, 1))) return startDate;
		}
	...
	const updateCurrentPage = (startDate) => {
		if (isMonthPicker && startDate.length >= 4 || startDate.length >= 8) setCurrentPage(startOfPage(parseDate(startDate)));
	};
	const announceStart = (startDate) => {
		return `${i18n("i18nStrings.startDateLabel", i18nStrings === null || i18nStrings === void 0 ? void 0 : i18nStrings.startDateLabel)}, ${getDateLabel$1(normalizedLocale, startDate)}${hideTime ? "" : `, ${i18n("i18nStrings.startTimeLabel", i18nStrings === null || i18nStrings === void 0 ? void 0 : i18nStrings.startTimeLabel)}, ${renderTimeLabel(normalizedLocale, startDate, timeInputFormat)}`}. `;
	};
	const announceEnd = (endDate) => {
		return `${i18n("i18nStrings.endDateLabel", i18nStrings === null || i18nStrings === void 0 ? void 0 : i18nStrings.endDateLabel)}, ${getDateLabel$1(normalizedLocale, endDate)}${hideTime ? "" : `, ${i18n("i18nStrings.endTimeLabel", i18nStrings === null || i18nStrings === void 0 ? void 0 : i18nStrings.endTimeLabel)}, ${renderTimeLabel(normalizedLocale, endDate, timeInputFormat)}`}. `;
	};
	...
	const announceRange = (startDate, endDate) => {
		if (!renderSelectedAbsoluteRangeAriaLive) return `${getDateLabel$1(normalizedLocale, startDate)} – ${getDateLabel$1(normalizedLocale, endDate)}`;
		return renderSelectedAbsoluteRangeAriaLive(getDateLabel$1(normalizedLocale, startDate), getDateLabel$1(normalizedLocale, endDate));
	};
	const onSelectDateHandler = (selectedDate) => {
		...
		const formatValue = (date, previous, includeTime) => {
			...
			else if (date === void 0) return previous;
	...
	const onHeaderChangePageHandler = (amount) => {
		...
		setFocusedDate(getBaseFn(newBasePage, isDateEnabled));
	};
	...
	return import_react.createElement(import_react.Fragment, null, import_react.createElement("div", { className: clsx(styles_css_default$2["calendar-container"], { [styles_css_default$2["one-grid"]]: isSingleGrid }) }, import_react.createElement(InternalSpaceBetween, { size: "s" }, import_react.createElement("div", { className: clsx(styles_css_default$2.calendar, { [styles_css_default$2["one-grid"]]: isSingleGrid }) }, import_react.createElement(CalendarHeader, {
		granularity,
		...
		isSingleGrid,
		headingIdPrefix
	}), import_react.createElement(Grids, {
		granularity,
		isSingleGrid,
		locale: normalizedLocale,
		baseDate: currentPage,
		...
		headingIdPrefix,
		referrerId
	})), import_react.createElement(RangeInputs, {
		startDate: value.start.date,
		onChangeStartDate,
		startTime: value.start.time,
		onChangeStartTime: (value) => setValue((oldValue) => ({
			...oldValue,
			start: {
				...oldValue.start,
				time: value
		...
		onChangeEndDate: (value) => setValue((oldValue) => ({
			...oldValue,
			end: {
				...oldValue.end,
				date: value
		...
		onChangeEndTime: (value) => setValue((oldValue) => ({
			...oldValue,
			end: {
				...oldValue.end,
				time: value
		...
		dateInputFormat,
		granularity
	}), customAbsoluteRangeControl && import_react.createElement("div", null, customAbsoluteRangeControl(value, interceptedSetValue)))), import_react.createElement(internal_default, {
		className: styles_css_default$4["calendar-aria-live"],
		hidden: true,
		tagName: "span"
	}, announcement));
}
//#endregion
//#region node_modules/@cloudscape-design/components/date-range-picker/mode-switcher.js
function ModeSwitcher({ i18nStrings, mode, onChange }) {
	const i18n = useInternalI18n("date-range-picker");
	return import_react.createElement(InternalSegmentedControl, {
		className: styles_css_default$4["mode-switch"],
		selectedId: mode,
		label: i18nStrings === null || i18nStrings === void 0 ? void 0 : i18nStrings.modeSelectionLabel,
		options: [{
			id: "relative",
			text: i18n("i18nStrings.relativeModeTitle", i18nStrings === null || i18nStrings === void 0 ? void 0 : i18nStrings.relativeModeTitle)
		}, {
			id: "absolute",
			text: i18n("i18nStrings.absoluteModeTitle", i18nStrings === null || i18nStrings === void 0 ? void 0 : i18nStrings.absoluteModeTitle)
		}],
		onChange: (e) => onChange(e.detail.selectedId)
	});
}
//#endregion
//#region node_modules/@cloudscape-design/components/date-range-picker/relative-range/styles.css.js
...
//#endregion
//#region node_modules/@cloudscape-design/components/date-range-picker/relative-range/index.js
...
function RelativeRangePicker({ dateOnly, options: clientOptions = [], initialSelection: initialRange, onChange: onChangeRangeSize, i18nStrings, isSingleGrid, customUnits, granularity = "day", renderRelativeRangeContent }) {
	var _a;
	const i18n = useInternalI18n("date-range-picker");
	const formatRelativeRange = i18n("i18nStrings.formatRelativeRange", i18nStrings === null || i18nStrings === void 0 ? void 0 : i18nStrings.formatRelativeRange, (format) => ({ amount, unit }) => format({
		amount,
		unit
	}));
	const formatUnit = i18n("i18nStrings.formatUnit", i18nStrings === null || i18nStrings === void 0 ? void 0 : i18nStrings.formatUnit, (format) => (unit, amount) => format({
		amount,
		unit
	}));
	...
	const [selectedRadio, setSelectedRadio] = (0, import_react.useState)(() => {
		var _a;
		if (initialRange && !initialRange.key) return CUSTOM_OPTION_SELECT_KEY;
	...
	const [customDuration, setCustomDuration] = (0, import_react.useState)(() => {
		if (initialRange) return initialRange.amount;
		return NaN;
	});
	let finalUnits = granularity === "month" ? monthUnits : dateOnly ? dayUnits : units;
	if (customUnits) finalUnits = customUnits.filter((unit) => {
	...
	if (!finalUnits.includes(initialCustomTimeUnit)) initialCustomTimeUnit = finalUnits[0];
	const [customUnitOfTime, setCustomUnitOfTime] = (0, import_react.useState)((_a = initialRange === null || initialRange === void 0 ? void 0 : initialRange.unit) !== null && _a !== void 0 ? _a : initialCustomTimeUnit);
	if (renderRelativeRangeContent) return import_react.createElement(import_react.Fragment, null, renderRelativeRangeContent(initialRange, onChangeRangeSize));
	...
	return import_react.createElement("div", null, import_react.createElement(InternalSpaceBetween, {
		size: "xs",
		direction: "vertical"
	}, showRadioControl && import_react.createElement(InternalFormField, {
		...
		className: styles_css_default$4["relative-range-radio-group"],
		onChange: ({ detail }) => {
		...
		value: selectedRadio,
		items: radioOptions
	})), showCustomControls && import_react.createElement(InternalSpaceBetween, {
		direction: "vertical",
		size: "xs"
	}, !showRadioControl && import_react.createElement(InternalBox, {
		fontSize: "body-m",
		color: "text-body-secondary"
	}, i18n("i18nStrings.customRelativeRangeOptionDescription", i18nStrings === null || i18nStrings === void 0 ? void 0 : i18nStrings.customRelativeRangeOptionDescription)), import_react.createElement("div", { className: clsx(styles_css_default["custom-range"], { [styles_css_default["custom-range--no-padding"]]: !showRadioControl }) }, import_react.createElement("div", { className: clsx(styles_css_default["custom-range-form-controls"], { [styles_css_default.vertical]: isSingleGrid }) }, import_react.createElement("div", { className: styles_css_default["custom-range-duration"] }, import_react.createElement(InternalFormField, { label: i18n("i18nStrings.customRelativeRangeDurationLabel", i18nStrings === null || i18nStrings === void 0 ? void 0 : i18nStrings.customRelativeRangeDurationLabel) }, import_react.createElement(internal_default$1, {
		type: "number",
		className: styles_css_default$4["custom-range-duration-input"],
	...
	}))), import_react.createElement("div", { className: styles_css_default["custom-range-unit"] }, import_react.createElement(InternalFormField, { label: i18n("i18nStrings.customRelativeRangeUnitLabel", i18nStrings === null || i18nStrings === void 0 ? void 0 : i18nStrings.customRelativeRangeUnitLabel) }, import_react.createElement(InternalSelect, {
		className: styles_css_default$4["custom-range-unit-select"],
		selectedOption: {
...
//#endregion
//#region node_modules/@cloudscape-design/components/date-range-picker/time-offset.js
/**
...
function setTimeOffset(value, timeOffset) {
	if (!((value === null || value === void 0 ? void 0 : value.type) === "absolute")) return value;
...
function shiftTimeOffset(value, timeOffset) {
	if (!value || value.type !== "absolute") return value;
...
function parseDateUTC(isoDateString) {
	return addMinutes(new Date(isoDateString), parseTimezoneOffset(isoDateString));
}
//#endregion
//#region node_modules/@cloudscape-design/components/date-range-picker/utils.js
...
function formatValue(value, { timeOffset, monthOnly, dateOnly }) {
	if (!isAbsoluteValue(value) || isEmptyAbsoluteValue(value)) return value;
	if (monthOnly || dateOnly) {
		const [startPart, endPart] = [value.startDate, value.endDate].map((date) => monthOnly ? date.split("T")[0].split("-").slice(0, 2).join("-") : date.split("T")[0]);
		return {
			type: "absolute",
			startDate: startPart,
			endDate: endPart
...
function getDefaultMode(value, relativeOptions, rangeSelectorMode) {
	if (value === null || value === void 0 ? void 0 : value.type) return value.type;
	if (rangeSelectorMode === "relative-only") return "relative";
	if (rangeSelectorMode === "absolute-only") return "absolute";
...
function formatInitialValue(value, dateOnly, monthOnly, normalizedTimeOffset) {
	if (!isAbsoluteValue(value)) return shiftTimeOffset(value, normalizedTimeOffset);
	if (isEmptyAbsoluteValue(value)) return value;
	if (dateOnly || monthOnly) return formatValue(value, {
		dateOnly,
		monthOnly,
		timeOffset: normalizedTimeOffset
	});
	if (isDateOrMonthOnly(value, isIsoDateOnly) || isDateOrMonthOnly(value, isIsoMonthOnly)) return value;
	return shiftTimeOffset(value, normalizedTimeOffset);
}
//#endregion
//#region node_modules/@cloudscape-design/components/date-range-picker/dropdown.js
var VALID_RANGE = { valid: true };
function DateRangePickerDropdown({ locale = "", startOfWeek, isDateEnabled, dateDisabledReason = () => "", isValidRange, value, onClear: clearValue, onApply: applyValue, getTimeOffset, timeOffset, onOutsideClick, relativeOptions, showClearButton, isSingleGrid, i18nStrings, dateOnly, absoluteFormat, timeInputFormat, dateInputFormat, rangeSelectorMode, ariaLabelledby, ariaDescribedby, customAbsoluteRangeControl, customRelativeRangeUnits, renderRelativeRangeContent, granularity = "day", referrerId, absoluteMultiGridStartPeriod }) {
	const i18n = useInternalI18n("date-range-picker");
	const isMonthPicker = granularity === "month";
	const hideTime = dateOnly || isMonthPicker;
	const liveRegionRef = (0, import_react.useRef)(null);
	const [rangeSelectionMode, setRangeSelectionMode] = (0, import_react.useState)(getDefaultMode(value, relativeOptions, rangeSelectorMode));
	const [selectedAbsoluteRange, setSelectedAbsoluteRange] = (0, import_react.useState)(() => splitAbsoluteValue((value === null || value === void 0 ? void 0 : value.type) === "absolute" ? value : null, hideTime));
	const [selectedRelativeRange, setSelectedRelativeRange] = (0, import_react.useState)((value === null || value === void 0 ? void 0 : value.type) === "relative" ? value : null);
	const scrollableContainerRef = (0, import_react.useRef)(null);
	const applyButtonRef = (0, import_react.useRef)(null);
	const [applyClicked, setApplyClicked] = (0, import_react.useState)(false);
	const [validationResult, setValidationResult] = (0, import_react.useState)(VALID_RANGE);
	const closeDropdown = () => {
	...
	const onApply = () => {
		var _a;
		const newValidationResult = applyValue(rangeSelectionMode === "relative" ? selectedRelativeRange : joinAbsoluteValue(selectedAbsoluteRange, hideTime));
		if (newValidationResult.valid === false) {
			setApplyClicked(true);
			setValidationResult(newValidationResult);
			(_a = liveRegionRef.current) === null || _a === void 0 || _a.reannounce();
		} else {
			setApplyClicked(false);
			closeDropdown();
		}
	...
	(0, import_react.useEffect)(() => {
		if (applyClicked) {
			...
			setValidationResult(isValidRange(formatValue(visibleRange, {
				dateOnly,
	...
	return import_react.createElement(import_react.Fragment, null, import_react.createElement(focus_lock_default, {
		className: styles_css_default$2["focus-lock"],
		autoFocus: true
	}, import_react.createElement("div", {
		ref: scrollableContainerRef,
		className: clsx(styles_css_default$2.dropdown, styles_css_default$4.dropdown),
		tabIndex: 0,
		role: "dialog",
	...
	}, import_react.createElement("div", { className: clsx(styles_css_default$2["dropdown-content"], { [styles_css_default$2["one-grid"]]: isSingleGrid }) }, import_react.createElement(InternalSpaceBetween, { size: "l" }, import_react.createElement(InternalBox, { padding: {
		top: "m",
		horizontal: "l"
	} }, import_react.createElement(InternalSpaceBetween, {
		direction: "vertical",
		size: "s"
	}, rangeSelectorMode === "default" && import_react.createElement(ModeSwitcher, {
		...
		i18nStrings
	}), rangeSelectionMode === "absolute" && import_react.createElement(DateRangePickerCalendar, {
	...
	}), rangeSelectionMode === "relative" && import_react.createElement(RelativeRangePicker, {
		isSingleGrid,
		...
		className: styles_css_default$4["validation-section"],
		margin: !validationResult.valid ? { top: "s" } : void 0
	}, !validationResult.valid && import_react.createElement(import_react.Fragment, null, import_react.createElement(InternalAlert, {
		type: "error",
	...
	}, import_react.createElement("span", { className: styles_css_default$4["validation-error"] }, validationResult.errorMessage)), import_react.createElement(internal_default, {
		hidden: true,
		tagName: "span",
		ref: liveRegionRef
	}, validationResult.errorMessage)))), import_react.createElement("div", { className: clsx(styles_css_default$2.footer, {
		[styles_css_default$2["one-grid"]]: isSingleGrid,
		[styles_css_default$2["has-clear-button"]]: showClearButton
	}) }, showClearButton && import_react.createElement("div", { className: styles_css_default$2["footer-button-wrapper"] }, import_react.createElement(InternalButton, {
		onClick: onClear,
		className: styles_css_default$4["clear-button"],
		variant: "link",
		formAction: "none"
	}, i18n("i18nStrings.clearButtonLabel", i18nStrings === null || i18nStrings === void 0 ? void 0 : i18nStrings.clearButtonLabel))), import_react.createElement("div", { className: styles_css_default$2["footer-button-wrapper"] }, import_react.createElement(InternalSpaceBetween, {
		size: "xs",
		direction: "horizontal"
	}, import_react.createElement(InternalButton, {
		onClick: closeDropdown,
		className: styles_css_default$4["cancel-button"],
		variant: "link",
		formAction: "none"
	}, i18n("i18nStrings.cancelButtonLabel", i18nStrings === null || i18nStrings === void 0 ? void 0 : i18nStrings.cancelButtonLabel)), import_react.createElement(InternalButton, {
		onClick: onApply,
		className: styles_css_default$4["apply-button"],
		ref: applyButtonRef,
		formAction: "none"
	}, i18n("i18nStrings.applyButtonLabel", i18nStrings === null || i18nStrings === void 0 ? void 0 : i18nStrings.applyButtonLabel))))))))));
}
//#endregion
//#region node_modules/@cloudscape-design/components/date-range-picker/index.js
function renderDateRange({ locale, range, placeholder = "", formatRelativeRange, absoluteFormat, hideTimeOffset, timeOffset }) {
	...
	return import_react.createElement("span", {
		className: !range && styles_css_default$2["label-text"] || void 0,
		"aria-disabled": !range
	}, import_react.createElement("span", { className: (range === null || range === void 0 ? void 0 : range.type) === "absolute" ? styles_css_default$2["label-token-nowrap"] : void 0 }, firstPart), import_react.createElement("span", null, secondPart && " — "), import_react.createElement("span", { className: styles_css_default$2["label-token-nowrap"] }, secondPart));
}
var DateRangePicker = import_react.forwardRef(({ locale = "", startOfWeek, isDateEnabled = () => true, dateDisabledReason, value, placeholder, readOnly = false, disabled = false, onChange, onBlur, onFocus, relativeOptions = [], i18nStrings, isValidRange = () => ({ valid: true }), showClearButton = true, dateOnly = false, ariaLabel, timeOffset, getTimeOffset, timeInputFormat = "hh:mm:ss", dateInputFormat = "slashed", expandToViewport = false, rangeSelectorMode = "default", customAbsoluteRangeControl, absoluteFormat = "iso", hideTimeOffset, customRelativeRangeUnits, renderRelativeRangeContent, granularity = "day", absoluteMultiGridStartPeriod = "auto", renderTriggerContent, ...rest }, ref) => {
	var _a, _b;
	...
	const closeDropdown = (focusTrigger = false) => {
		...
		if (focusTrigger) (_a = triggerRef.current) === null || _a === void 0 || _a.focus();
	};
	...
	const onApply = (newValue) => {
		...
		if ((validationResult === null || validationResult === void 0 ? void 0 : validationResult.valid) === false) return validationResult;
		if ((newValue === null || newValue === void 0 ? void 0 : newValue.type) === "absolute") {
			...
			if (!startDateWithoutTime || !endDateWithoutTime) warnOnce("DateRangePicker", "You have provided an `isValidRange` prop that did not catch a missing start or end date.");
		}
	...
	(0, import_react.useEffect)(() => {
		if (prevDateOnly !== void 0 && prevDateOnly !== dateOnly) warnOnce("DateRangePicker", `The provided \`dateOnly\` flag has been changed from "${prevDateOnly}" to "${dateOnly}" which can lead to unexpected value format. Consider using separate components.`);
	...
	const formatRelativeRange = useInternalI18n("date-range-picker")("i18nStrings.formatRelativeRange", i18nStrings === null || i18nStrings === void 0 ? void 0 : i18nStrings.formatRelativeRange, (format) => ({ amount, unit }) => format({
		amount,
		unit
	}));
	if (!formatRelativeRange && rangeSelectorMode !== "absolute-only") warnOnce("DateRangePicker", "A function for i18nStrings.formatRelativeRange was not provided. Relative ranges will not be correctly rendered.");
	...
	const trigger = import_react.createElement(button_trigger_default, {
		ref: triggerRef,
		id: controlId,
		invalid,
		warning,
		...
		ariaDescribedby,
		className: clsx(styles_css_default$4.label, styles_css_default$2.label, { [styles_css_default$2["label-enabled"]]: !readOnly && !disabled }),
		hideCaret: true,
		onClick: () => {
		...
		readOnly,
		ariaHasPopup: "dialog"
	}, renderTriggerContent ? import_react.createElement("div", { id: triggerContentId }, renderTriggerContent({ formattedDate })) : import_react.createElement("span", { className: styles_css_default$2["trigger-flexbox"] }, import_react.createElement("span", { className: styles_css_default$2["icon-wrapper"] }, import_react.createElement(InternalIcon, {
		name: "calendar",
		variant: disabled || readOnly ? "disabled" : "normal"
	})), import_react.createElement("span", { id: triggerContentId }, formattedDate)));
	const mergedRef = useMergeRefs(rootRef, __internalRootRef);
	const referrerId = useUniqueId();
	return import_react.createElement("div", {
		...baseProps,
		ref: mergedRef,
		className: clsx(baseProps.className, styles_css_default$2.root, styles_css_default$4.root, absoluteFormat === "long-localized" && !dateOnly && !isMonthOnly && styles_css_default$2.wide),
		...
		content: import_react.createElement(ResetContextsForModal, null, isDropDownOpen && import_react.createElement(DateRangePickerDropdown, {
			startOfWeek,
			locale: normalizedLocale,
			isSingleGrid,
...
//#endregion
export { useDateCache as C, isSameMonth as D, isSameYear as E, isSameDay as O, normalizeLocale as S, formatDateTime as T, getDateLabel$1 as _, getCalendarMonthWithSixRows as a, renderYear as b, moveMonthDown as c, movePrevMonth as d, getBaseDay as f, movePrevWeek as g, movePrevDay as h, InternalDateInput as i, addYears as k, moveMonthUp as l, moveNextWeek as m, InternalTimeInput as n, getCalendarYear as o, moveNextDay as p, useFocusTracker as r, getBaseMonth as s, DateRangePicker as t, moveNextMonth as u, renderDayName$1 as v, parseDate as w, normalizeStartOfWeek as x, renderMonthAndYear$1 as y };

//# sourceMappingURL=date-range-picker-CNy6iVsw.js.map