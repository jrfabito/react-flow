...
import { t as flattenChildren } from "./flatten-children-91ka3nkc.js";
...
var InternalGrid = import_react.forwardRef(({ __breakpoint, gridDefinition = [], disableGutters = false, children, __tagOverride, __responsiveClassName, __internalRootRef, ...restProps }, ref) => {
	...
	return import_react.createElement(Tag, {
		...baseProps,
		className: clsx(styles_css_default.grid, baseProps.className, { [styles_css_default["no-gutters"]]: disableGutters }, __responsiveClassName ? __responsiveClassName(defaultBreakpoint) : null),
		ref: mergedRef
