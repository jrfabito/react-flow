//#region node_modules/@cloudscape-design/components/internal/breakpoints.js
...
function getMatchingBreakpoint(width, breakpointFilter) {
	for (const [breakpoint, breakpointWidth] of BREAKPOINT_MAPPING) if (width > breakpointWidth && (!breakpointFilter || breakpointFilter.indexOf(breakpoint) !== -1)) return breakpoint;
	return "default";
}
...
//#endregion
export { mobileBreakpoint as i, getMatchingBreakpoint as n, matchBreakpointMapping as r, getBreakpointValue as t };

//# sourceMappingURL=breakpoints-1ZVW1PYe.js.map