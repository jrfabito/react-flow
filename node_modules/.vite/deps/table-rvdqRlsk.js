...
import { a as getColumnGroupsDepth, n as InternalTableAsSubstep, r as getSortingColumnId, t as InternalTable } from "./internal-MojShPRf.js";
import { r as getAnalyticsMetadataAttribute } from "./attributes-B5i4jWw3.js";
import { r as AnalyticsFunnelSubStep } from "./analytics-funnel-CyM2Ws8-.js";
//#region node_modules/@cloudscape-design/components/internal/context/collection-preferences-metadata-context.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var CollectionPreferencesMetadata = (0, import_react.createContext)({});
//#endregion
//#region node_modules/@cloudscape-design/components/table/index.js
var Table = import_react.forwardRef(({ items = [], selectedItems = [], variant = "container", contentDensity = "comfortable", cellVerticalAlign = "middle", firstIndex = 1, ...props }, ref) => {
	var _a, _b, _c, _d, _e;
	const analyticsMetadata = getAnalyticsMetadataProps(props);
	const hasHiddenColumns = props.visibleColumns && props.visibleColumns.length < props.columnDefinitions.length || ((_a = props.columnDisplay) === null || _a === void 0 ? void 0 : _a.some((col) => col.type !== "group" && !col.visible));
	...
	const baseComponentProps = useBaseComponent("Table", {
		...
		metadata: {
			...
			columnGroups: !!((_e = props.groupDefinitions) === null || _e === void 0 ? void 0 : _e.length),
	...
	if (variant === "borderless" || variant === "embedded") return import_react.createElement(CollectionPreferencesMetadata.Provider, { value: collectionPreferencesMetadata }, import_react.createElement(InternalTable, { ...tableProps }));
	return import_react.createElement(CollectionPreferencesMetadata.Provider, { value: collectionPreferencesMetadata }, import_react.createElement(AnalyticsFunnelSubStep, null, import_react.createElement(InternalTableAsSubstep, { ...tableProps })));
});
applyDisplayName(Table, "Table");
//#endregion
export { CollectionPreferencesMetadata as n, Table as t };

//# sourceMappingURL=table-rvdqRlsk.js.map