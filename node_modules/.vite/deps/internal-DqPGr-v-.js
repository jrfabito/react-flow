...
import { A as clsx, E as useStableCallback, _ as useReducedMotion, a as useVisualRefresh, b as warnOnce, s as getBaseProps, x as findUpUntil } from "./apply-display-name-CC28XEIj.js";
...
import { i as nodeBelongs, r as useSingleTabStopNavigation } from "./single-tab-stop-CduGKeFb.js";
...
import { n as getAnalyticsLabelAttribute, r as getAnalyticsMetadataAttribute } from "./attributes-B5i4jWw3.js";
import { a as reportRuntimeApiWarning, d as __spreadArray, i as awsuiPluginsInternal, l as __extends, n as useInternalI18n, o as __assign, u as __rest } from "./context-DHPsjtJl.js";
import { t as InternalIcon } from "./internal-DhFm8Nkw.js";
import { n as with_native_attributes_default } from "./with-native-attributes-B0xgeG3E.js";
import { a as useFunnelSubStep, d as findUpUntilMultiple, p as isContainingBlock, r as useFunnelStep, t as useFunnel, v as FunnelMetrics } from "./use-funnel-m7hdcICo.js";
...
import { n as getFirstScrollableParent, o as scrollRectangleIntoView, t as calculateScroll } from "./scrollable-containers-CljpU4av.js";
...
import { n as KeyCode, t as checkSafeUrl } from "./check-safe-url-Cm6I27h5.js";
import { i as useModalContext, n as useModalContextLoadingButtonComponent, t as InternalSpinner } from "./internal-DYKAgWvg2.js";
...
var styles_css_default$10 = { "root": "awsui_root_oip5a_160mh_5" };
//#endregion
...
function TabTrap({ focusNextCallback, disabled = false }) {
	return import_react.createElement("div", {
		className: styles_css_default$10.root,
...
var Arrow = ({ position, variant }) => {
	...
	return import_react.createElement("div", { className: clsx(styles_css_default$9.arrow, styles_css_default$9[`arrow-position-${position}`], styles_css_default$9[`arrow-variant-${variant}`]) }, import_react.createElement("div", { className: styles_css_default$9["arrow-outer"] }), import_react.createElement("div", { className: clsx(styles_css_default$9["arrow-inner"], isVisualRefresh && styles_css_default$9.refresh) }));
};
...
var styles_css_default$8 = { "root": "awsui_root_37gf8_1udtb_9" };
//#endregion
...
var ActionsWrapper = ({ className, testUtilClasses, action, discoveredActions, buttonText, wrappedClass, containerWidth, onButtonClick }) => {
	...
	return import_react.createElement("div", {
		ref,
		className: clsx(styles_css_default$8.root, className, wrapped && wrappedClass)
...
var styles_css_default$7 = { "header": "awsui_header_17427_1ns0c_5" };
//#endregion
...
var InternalAlert = import_react.forwardRef(({ type, i18nStrings, visible = true, dismissible, children, header, buttonText, action, onDismiss, onButtonClick, __internalRootRef, statusIconAriaLabel: deprecatedStatusIconAriaLabel, dismissAriaLabel: deprecatedDismissAriaLabel, messageSlotId, style, persistenceConfig, ...rest }, ref) => {
	...
	return import_react.createElement("div", {
		...
		className: clsx(styles_css_default$6.root, {
			[styles_css_default$6.hidden]: !visible,
			[styles_css_default$6["initial-hidden"]]: initialHidden
		}, baseProps.className),
		ref: containerRef
		...
		className: clsx(styles_css_default$6.alert, styles_css_default$6[`type-${type}`], styles_css_default$6[`icon-size-${size}`], hasAction && styles_css_default$6["with-action"], dismissible && styles_css_default$6["with-dismiss"]),
		style: getAlertStyles(style)
	}, import_react.createElement("div", { className: styles_css_default$6["alert-wrapper"] }, import_react.createElement("div", {
		className: styles_css_default$6["alert-focus-wrapper"],
		ref: focusRef,
		role: "group",
		onBlur: handleBlur
	}, import_react.createElement("div", {
		className: clsx(styles_css_default$6.icon, styles_css_default$6.text),
		...
		className: clsx(styles_css_default$6.message, styles_css_default$6.text),
		id: messageSlotId
	}, import_react.createElement("div", {
		className: clsx(header && styles_css_default$6.header, headerReplacementType !== "original" ? styles_css_default$6.hidden : styles_css_default$7.header),
		ref: headerRef
	}, header), import_react.createElement("div", {
		className: clsx(styles_css_default$6["header-replacement"], headerReplacementType !== "replaced" ? styles_css_default$6.hidden : styles_css_default$7.header),
		ref: replacementHeaderRef
	}), import_react.createElement("div", {
		className: clsx(styles_css_default$6.content, contentReplacementType !== "original" && styles_css_default$6.hidden),
		ref: contentRef
	}, children), import_react.createElement("div", {
		className: clsx(styles_css_default$6["content-replacement"], contentReplacementType !== "replaced" && styles_css_default$6.hidden),
		ref: replacementContentRef
	}))), import_react.createElement(ActionsWrapper, {
		className: styles_css_default$6.action,
		testUtilClasses: {
			actionSlot: styles_css_default$6["action-slot"],
			actionButton: styles_css_default$6["action-button"]
		},
		action,
		discoveredActions,
		buttonText,
		...
		containerWidth,
		wrappedClass: styles_css_default$6["action-wrapped"]
	})), dismissible && import_react.createElement("div", {
		className: styles_css_default$6.dismiss,
		...getAnalyticsMetadataAttribute({ action: "dismiss" })
	}, import_react.createElement(InternalButton, {
		className: styles_css_default$6["dismiss-button"],
		variant: "icon",
		iconName: "close",
		formAction: "none",
...
function ErrorBoundaryFallback({ i18nStrings = {}, renderFallback, ...props }) {
	...
	const defaultSlots = {
		header: import_react.createElement("div", { className: clsx(styles_css_default$5.header, styles_css_default$4.header) }, import_react.createElement(DefaultHeaderContent, { i18nStrings })),
		description: import_react.createElement("div", { className: clsx(styles_css_default$5.description, styles_css_default$4.description) }, import_react.createElement(DefaultDescriptionContent, { i18nStrings })),
		action: canUseRefresh() ? import_react.createElement("div", { className: clsx(styles_css_default$5.action, styles_css_default$4.action) }, import_react.createElement(DefaultActionContent, { i18nStrings })) : null
	};
	return import_react.createElement("div", {
		...baseProps,
		className: clsx(baseProps.className, styles_css_default$4.fallback)
...
function DefaultDescriptionContent({ i18nStrings: { descriptionText, components: { Feedback } = {} } = {} }) {
	...
	const formatArgs = Feedback ? {
		...
		Feedback: (chunks) => {
			var _a;
			return import_react.createElement("span", { className: styles_css_default$4["feedback-action"] }, import_react.createElement(Feedback, null, (_a = chunks[0]) !== null && _a !== void 0 ? _a : ""));
		}
	} : {
		hasFeedback: false,
...
function DefaultActionContent({ i18nStrings }) {
	...
	return import_react.createElement(InternalButton, {
		iconName: "refresh",
		onClick: refreshPage,
		className: styles_css_default$4["refresh-action"]
...
function InternalErrorBoundary({ children, suppressNested, suppressible, __internalRootRef, ...props }) {
	...
	return import_react.createElement("div", {
		ref: mergedRef,
		className: styles_css_default$5["error-boundary"],
...
function AppLayoutBuiltInErrorBoundary({ wrapper, suppressNested = false, children, renderFallback = () => import_react.createElement(import_react.Fragment, null) }) {
	...
	return import_react.createElement(ErrorBoundaryImpl, {
		...
		wrapper,
		renderFallback,
		className: styles_css_default$5["app-layout-part-fallback"],
		onError: (error) => {
			var _a;
...
var PopoverBody = import_react.forwardRef(({ dismissButton: showDismissButton, dismissAriaLabel, disableDismissAutoFocus = false, header, children, onDismiss, onBlur, variant, overflowVisible, className, ariaLabelledby, closeAnalyticsAction }, ref) => {
	...
	const dismissButton = (showDismissButton !== null && showDismissButton !== void 0 ? showDismissButton : null) && import_react.createElement("div", {
		className: styles_css_default$9.dismiss,
		...closeAnalyticsAction ? getAnalyticsMetadataAttribute({ action: closeAnalyticsAction }) : {}
	}, import_react.createElement(InternalButton, {
		variant: "icon",
		formAction: "none",
		iconName: "close",
		className: styles_css_default$9["dismiss-control"],
	...
	return import_react.createElement("div", {
		className: clsx(styles_css_default$9.body, styles_css_default$9[`body-variant-${variant}`], className, { [styles_css_default$9["body-overflow-visible"]]: overflowVisible === "both" }),
		onKeyDown,
		ref,
		onBlur,
		...dialogProps
		...
		autoFocus: false
	}, header && import_react.createElement("div", { className: clsx(styles_css_default$9["header-row"], showDismissButton && styles_css_default$9["has-dismiss"]) }, dismissButton, import_react.createElement("div", {
		className: styles_css_default$9.header,
		id: labelledById
	}, import_react.createElement("h2", null, header))), import_react.createElement("div", { className: !header && showDismissButton ? styles_css_default$9["has-dismiss"] : void 0 }, !header && dismissButton, import_react.createElement("div", { className: clsx(styles_css_default$9.content, { [styles_css_default$9["content-overflow-visible"]]: !!overflowVisible }) }, children)))));
});
//#endregion
...
function PopoverContainer({ position, trackRef, getTrack: externalGetTrack, trackKey, triggerClampRef, minVisibleBlockSize, arrow, children, zIndex, renderWithPortal, size, fixedWidth, variant, keepPosition, allowScrollToFit, allowVerticalOverflow, hideOnOverscroll, hoverArea, className }) {
	...
	return isOverscrolling ? null : import_react.createElement("div", {
		...
		className: clsx(styles_css_default$9.container, isRefresh && styles_css_default$9.refresh, className)
	}, import_react.createElement("div", {
		ref: arrowRef,
		className: clsx(styles_css_default$9[`container-arrow`], styles_css_default$9[`container-arrow-position-${internalPosition}`]),
		"aria-hidden": true
	}, arrow(internalPosition)), import_react.createElement("div", {
		ref: bodyRef,
		className: clsx(styles_css_default$9["container-body"], styles_css_default$9[`container-body-size-${size}`], {
			[styles_css_default$9["fixed-width"]]: fixedWidth,
			[styles_css_default$9[`container-body-variant-${variant}`]]: variant
		})
	}, hoverArea ? import_react.createElement("div", { className: styles_css_default$9["hover-area"] }, import_react.createElement("div", { ref: contentRef }, children)) : import_react.createElement("div", { ref: contentRef }, children)));
}
//#endregion
...
//#endregion
export { useVisualContext as A, getAllFocusables as B, usePerformanceMarks as C, ButtonContext as D, useHiddenDescription as E, classNamesShape as F, getIsRtl as G, getLastFocusable as H, require_prop_types as I, getLogicalPageX as J, getLogicalBoundingClientRect as K, _inheritsLoose as L, Transition$1 as M, forceReflow as N, VisualContext as O, TransitionGroupContext_default as P, _objectWithoutPropertiesLoose as R, styles_css_default$9 as S, useDOMAttribute as T, isFocusable as U, getFirstFocusable as V, Portal as W, getScrollInlineStart as X, getOffsetInlineStart as Y, persistFeatureNotifications as _, PopoverContainer as a, retrieveFlashbarDismiss as b, AppLayoutBuiltInErrorBoundary as c, InternalAlert as d, styles_css_default$7 as f, createUseDiscoveredAction as g, createUseDiscoveredContent as h, styles_css_default$3 as i, Transition as j, getVisualContextClassname as k, BuiltInErrorBoundary as l, useContainerWidth as m, styles_css_default$2 as n, PopoverBody as o, ActionsWrapper as p, getLogicalClientX as q, InternalTooltip as r, focus_lock_default as s, InternalButton as t, InternalErrorBoundary as u, persistFlashbarDismiss as v, useEffectOnUpdate as w, arrow_default as x, retrieveFeatureNotifications as y, TabTrap as z };

//# sourceMappingURL=internal-DqPGr-v-.js.map