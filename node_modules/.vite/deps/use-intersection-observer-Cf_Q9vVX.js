...
import { A as clsx } from "./apply-display-name-CC28XEIj.js";
import { t as nodeContains } from "./node-contains-CmRga37F.js";
import { G as getIsRtl, K as getLogicalBoundingClientRect, W as Portal, X as getScrollInlineStart, a as PopoverContainer, i as styles_css_default$3, j as Transition, o as PopoverBody, x as arrow_default } from "./internal-DqPGr-v-.js";
...
var styles_css_default$2 = { "root": "awsui_root_1qprf_160mh_5" };
//#endregion
...
function Tooltip({ value, trackRef, trackKey, className, contentAttributes = {}, position = "top", size = "small", hideOnOverscroll, onDismiss }) {
	...
	return import_react.createElement(Portal, null, import_react.createElement("div", {
		className: `${styles_css_default$2.root} ${styles_css_default$3.root}`,
		...contentAttributes,
...
function DirectionButton({ direction, state, show, onClick, forcedPosition, forcedIndex }) {
	return import_react.createElement(Transition, { in: show }, (transitionState, ref) => import_react.createElement("span", {
		ref,
		className: clsx(styles_css_default$1["direction-button-wrapper"], !forcedPosition && styles_css_default$1[`direction-button-wrapper-${direction}`], forcedPosition && styles_css_default$1["direction-button-wrapper-forced"], forcedPosition && styles_css_default$1[`direction-button-wrapper-forced-${forcedPosition}-${forcedIndex}`], transitionState === "exited" && styles_css_default$1["direction-button-wrapper-hidden"], styles_css_default$1[`direction-button-wrapper-motion-${transitionState}`])
	}, import_react.createElement("span", {
		className: clsx(styles_css_default$1["direction-button"], state === "disabled" && styles_css_default$1["direction-button-disabled"], styles_css_default[`direction-button-${direction}`], !["exiting", "exited"].includes(transitionState) && styles_css_default["direction-button-visible"]),
...
function PortalOverlay({ track, isDisabled, referrerId, children }) {
	...
	return import_react.createElement(Portal, { container }, import_react.createElement("span", {
		...
		className: clsx(styles_css_default$1["portal-overlay"], isDisabled && styles_css_default$1["portal-overlay-disabled"])
	}, import_react.createElement("span", { className: styles_css_default$1["portal-overlay-contents"] }, children)));
}
//#endregion
...
function DragHandleWrapper({ directions, tooltipText, children, onDirectionClick, triggerMode = "focus", initialShowButtons = false, controlledShowButtons = false, wrapperClassName, hideButtonsOnDrag, clickDragThreshold }) {
	...
	return import_react.createElement(import_react.Fragment, null, import_react.createElement("div", {
		className: clsx(styles_css_default.root, styles_css_default$1.contents),
		ref: wrapperRef,
		onFocus: onWrapperFocusIn,
		onBlur: onWrapperFocusOut
	}, import_react.createElement("div", {
		className: styles_css_default$1.contents,
		onPointerEnter: onTooltipGroupPointerEnter,
		onPointerLeave: onTooltipGroupPointerLeave
	}, import_react.createElement("div", {
		className: clsx(styles_css_default$1["drag-handle"], wrapperClassName),
		ref: dragHandleRef,
		id: referrerId,
...
//#endregion
export { browserScrollbarSize as n, DragHandleWrapper as r, useIntersectionObserver as t };

//# sourceMappingURL=use-intersection-observer-Cf_Q9vVX.js.map