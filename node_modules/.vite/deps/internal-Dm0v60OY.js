...
import { D as useStableCallback, S as findUpUntil, c as getBaseProps, o as useVisualRefresh, t as clsx, v as useReducedMotion, x as warnOnce } from "./clsx.m-D3moizge.js";
...
import { i as nodeBelongs, r as useSingleTabStopNavigation } from "./single-tab-stop-DCNthGu8.js";
...
import { n as with_native_attributes_default } from "./with-native-attributes-DQK9BNA3.js";
...
import { n as getAnalyticsLabelAttribute, r as getAnalyticsMetadataAttribute } from "./attributes-CK-88-UH.js";
import { a as useFunnelSubStep, d as findUpUntilMultiple, p as isContainingBlock, r as useFunnelStep, t as useFunnel, v as FunnelMetrics } from "./use-funnel-C_csD3Y0.js";
...
import { a as reportRuntimeApiWarning, d as __spreadArray, i as awsuiPluginsInternal, l as __extends, n as useInternalI18n, o as __assign, u as __rest } from "./context-D2p1h4FA.js";
import { t as InternalIcon } from "./internal-eAhYllZm.js";
import { i as useModalContext, n as useModalContextLoadingButtonComponent, t as InternalSpinner } from "./internal-CiRy-Vuh.js";
import { n as checkSafeUrl, t as KeyCode } from "./keycode-Dk9ithL6.js";
import { t as internal_default } from "./internal-B5X71nun.js";
import { n as getFirstScrollableParent, o as scrollRectangleIntoView, t as calculateScroll } from "./scrollable-containers-CbAg9c3K.js";
...
function ErrorBoundaryFallback({ i18nStrings = {}, renderFallback, ...props }) {
	...
	const defaultSlots = {
		header: import_react.createElement("div", { className: clsx(styles_css_default$9.header, styles_css_default$8.header) }, import_react.createElement(DefaultHeaderContent, { i18nStrings })),
		description: import_react.createElement("div", { className: clsx(styles_css_default$9.description, styles_css_default$8.description) }, import_react.createElement(DefaultDescriptionContent, { i18nStrings })),
		action: canUseRefresh() ? import_react.createElement("div", { className: clsx(styles_css_default$9.action, styles_css_default$8.action) }, import_react.createElement(DefaultActionContent, { i18nStrings })) : null
	};
	return import_react.createElement("div", {
		...baseProps,
		className: clsx(baseProps.className, styles_css_default$8.fallback)
...
function DefaultDescriptionContent({ i18nStrings: { descriptionText, components: { Feedback } = {} } = {} }) {
	...
	const formatArgs = Feedback ? {
		...
		Feedback: (chunks) => {
			var _a;
			return import_react.createElement("span", { className: styles_css_default$8["feedback-action"] }, import_react.createElement(Feedback, null, (_a = chunks[0]) !== null && _a !== void 0 ? _a : ""));
		}
	} : {
		hasFeedback: false,
...
function DefaultActionContent({ i18nStrings }) {
	...
	return import_react.createElement(InternalButton, {
		iconName: "refresh",
		onClick: refreshPage,
		className: styles_css_default$8["refresh-action"]
...
function InternalErrorBoundary({ children, suppressNested, suppressible, __internalRootRef, ...props }) {
	...
	return import_react.createElement("div", {
		ref: mergedRef,
		className: styles_css_default$9["error-boundary"],
...
function AppLayoutBuiltInErrorBoundary({ wrapper, suppressNested = false, children, renderFallback = () => import_react.createElement(import_react.Fragment, null) }) {
	...
	return import_react.createElement(ErrorBoundaryImpl, {
		...
		wrapper,
		renderFallback,
		className: styles_css_default$9["app-layout-part-fallback"],
		onError: (error) => {
			var _a;
...
var styles_css_default$7 = { "root": "awsui_root_oip5a_160mh_5" };
//#endregion
...
function TabTrap({ focusNextCallback, disabled = false }) {
	return import_react.createElement("div", {
		className: styles_css_default$7.root,
...
var styles_css_default$6 = { "root": "awsui_root_1u26h_im8v7_5" };
//#endregion
...
function InternalTooltip({ content, getTrack, className, position = "top", onEscape, referrerId, __internalRootRef, ...restProps }) {
	...
	return import_react.createElement(Portal, null, import_react.createElement("div", {
		...baseProps,
		className: clsx(styles_css_default$6.root, baseProps.className),
...
function IconWrapper({ iconName, iconUrl, iconAlt, iconSvg, iconSize, badge, ...props }) {
	...
	return import_react.createElement(InternalIcon, {
		className: clsx(styles_css_default$5.icon, styles_css_default$5[`icon-${getIconAlign(props)}`], props.iconClass),
		name: iconName,
		url: iconUrl,
		svg: iconSvg,
		alt: iconAlt,
...
function LeftIcon(props) {
	if (props.loading) return import_react.createElement(InternalSpinner, { className: clsx(styles_css_default$5.icon, styles_css_default$5["icon-left"]) });
...
var styles_css_default$4 = { "label": "awsui_label_1f1d4_ocied_5" };
//#endregion
...
var InternalButton = import_react.forwardRef(({ children, iconName, __iconClass, __iconSize, onClick, onFollow, iconAlign = "left", iconUrl, iconSvg, iconAlt, variant = "normal", loading = false, loadingText, disabled = false, disabledReason, wrapText = true, href, external, target: targetOverride, rel, download, formAction = "submit", ariaLabel, ariaDescribedby, ariaExpanded, ariaHaspopup, ariaControls, fullWidth, badge, i18nStrings, style, nativeButtonAttributes, nativeAnchorAttributes, __internalRootRef, __focusable = false, __injectAnalyticsComponentMetadata = false, __title, __emitPerformanceMarks = true, __skipNativeAttributesWarnings, analyticsAction = "click", ...props }, ref) => {
	...
	const buttonClass = clsx(props.className, styles_css_default$5.button, styles_css_default$5[`variant-${variant}`], {
		[styles_css_default$5.disabled]: isNotInteractive,
		[styles_css_default$5["disabled-with-reason"]]: isDisabledWithReason,
		[styles_css_default$5["button-no-wrap"]]: !wrapText,
		[styles_css_default$5["button-no-text"]]: !shouldHaveContent,
		[styles_css_default$5["full-width"]]: shouldHaveContent && fullWidth,
		[styles_css_default$5.link]: isAnchor
	});
	...
	const buttonProps = {
		...
		...getAnalyticsLabelAttribute(shouldHaveContent ? `.${styles_css_default$4.label}` : "")
	};
	const iconProps = {
		loading,
		iconName,
	...
	const buttonContent = import_react.createElement(import_react.Fragment, null, import_react.createElement(LeftIcon, { ...iconProps }), shouldHaveContent && import_react.createElement(import_react.Fragment, null, import_react.createElement("span", { className: clsx(styles_css_default$5.content, styles_css_default$4.label) }, children), external && import_react.createElement(import_react.Fragment, null, "\xA0", import_react.createElement(InternalIcon, {
		name: "external",
		className: styles_css_default$3["external-icon"],
	...
	const disabledReasonContent = import_react.createElement(import_react.Fragment, null, descriptionEl, showTooltip && import_react.createElement(InternalTooltip, {
		className: styles_css_default$3["disabled-reason-tooltip"],
...
var styles_css_default$2 = { "root": "awsui_root_37gf8_1udtb_9" };
//#endregion
...
var ActionsWrapper = ({ className, testUtilClasses, action, discoveredActions, buttonText, wrappedClass, containerWidth, onButtonClick }) => {
	...
	return import_react.createElement("div", {
		ref,
		className: clsx(styles_css_default$2.root, className, wrapped && wrappedClass)
...
var styles_css_default$1 = { "header": "awsui_header_17427_1ns0c_5" };
//#endregion
...
var InternalAlert = import_react.forwardRef(({ type, i18nStrings, visible = true, dismissible, children, header, buttonText, action, onDismiss, onButtonClick, __internalRootRef, statusIconAriaLabel: deprecatedStatusIconAriaLabel, dismissAriaLabel: deprecatedDismissAriaLabel, messageSlotId, style, persistenceConfig, ...rest }, ref) => {
	...
	return import_react.createElement("div", {
		...
		...analyticsAttributes,
		"aria-hidden": !visible,
		className: clsx(styles_css_default.root, {
			[styles_css_default.hidden]: !visible,
			[styles_css_default["initial-hidden"]]: initialHidden
		}, baseProps.className),
		ref: containerRef
		...
		className: clsx(styles_css_default.alert, styles_css_default[`type-${type}`], styles_css_default[`icon-size-${size}`], hasAction && styles_css_default["with-action"], dismissible && styles_css_default["with-dismiss"]),
		style: getAlertStyles(style)
	}, import_react.createElement("div", { className: styles_css_default["alert-wrapper"] }, import_react.createElement("div", {
		className: styles_css_default["alert-focus-wrapper"],
		ref: focusRef,
		role: "group",
		onBlur: handleBlur
	}, import_react.createElement("div", {
		className: clsx(styles_css_default.icon, styles_css_default.text),
		...
		className: clsx(styles_css_default.message, styles_css_default.text),
		id: messageSlotId
	}, import_react.createElement("div", {
		className: clsx(header && styles_css_default.header, headerReplacementType !== "original" ? styles_css_default.hidden : styles_css_default$1.header),
		ref: headerRef
	}, header), import_react.createElement("div", {
		className: clsx(styles_css_default["header-replacement"], headerReplacementType !== "replaced" ? styles_css_default.hidden : styles_css_default$1.header),
		ref: replacementHeaderRef
	}), import_react.createElement("div", {
		className: clsx(styles_css_default.content, contentReplacementType !== "original" && styles_css_default.hidden),
		ref: contentRef
		...
		className: styles_css_default.action,
		testUtilClasses: {
...
//#endregion
export { styles_css_default$10 as A, useEffectOnUpdate as B, getLastFocusable as C, BuiltInErrorBoundary as D, AppLayoutBuiltInErrorBoundary as E, classNamesShape as F, getIsRtl as G, useHiddenDescription as H, require_prop_types as I, getLogicalPageX as J, getLogicalBoundingClientRect as K, _inheritsLoose as L, Transition$1 as M, forceReflow as N, InternalErrorBoundary as O, TransitionGroupContext_default as P, _objectWithoutPropertiesLoose as R, getFirstFocusable as S, TabTrap as T, ButtonContext as U, useDOMAttribute as V, Portal as W, getScrollInlineStart as X, getOffsetInlineStart as Y, styles_css_default$6 as _, createUseDiscoveredContent as a, focus_lock_default as b, persistFlashbarDismiss as c, VisualContext as d, getVisualContextClassname as f, InternalTooltip as g, styles_css_default$5 as h, useContainerWidth as i, Transition as j, arrow_default as k, retrieveFeatureNotifications as l, InternalButton as m, styles_css_default$1 as n, createUseDiscoveredAction as o, useVisualContext as p, getLogicalClientX as q, ActionsWrapper as r, persistFeatureNotifications as s, InternalAlert as t, retrieveFlashbarDismiss as u, PopoverContainer as v, isFocusable as w, getAllFocusables as x, PopoverBody as y, usePerformanceMarks as z };

//# sourceMappingURL=internal-Dm0v60OY.js.map