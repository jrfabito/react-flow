import { T as createSingletonState } from "./apply-display-name-CC28XEIj.js";
import { i as mobileBreakpoint, n as getMatchingBreakpoint } from "./breakpoints-1ZVW1PYe.js";
//#region node_modules/@cloudscape-design/components/internal/hooks/use-mobile/index.js
var forceMobileModeSymbol = Symbol.for("awsui-force-mobile-mode");
function getIsMobile() {
	var _a;
	const forceMobileMode = globalThis[forceMobileModeSymbol];
	if (typeof forceMobileMode !== "undefined") return forceMobileMode;
...
//#endregion
export { useMobile as t };

//# sourceMappingURL=use-mobile-CTWoN9ri.js.map