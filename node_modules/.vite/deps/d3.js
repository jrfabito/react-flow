import { t as path$1 } from "./path-Bb52FxWk.js";
import { $ as window_default, A as nogamma, B as rgbConvert, C as date_default, D as rgbBasisClosed, E as rgbBasis, F as brighter, G as yesdrag, H as extend, I as color, J as select_default, K as pointer_default, L as darker, M as basis_default$1, N as Color, O as rgb_default, P as Rgb, Q as styleValue, R as hsl, S as number_default, T as numberArray_default, U as drag_default, V as define_default, W as nodrag_default, X as root, Y as Selection, Z as selection, _ as interpolateTransformCss, a as active_default, at as namespace_default, b as string_default, c as cubicOut, d as timeout_default, et as matcher_default, f as Timer, g as zoom_default, h as timerFlush, i as transform, it as creator_default, j as basisClosed_default$1, k as hue, l as transition, m as timer, n as Transform, nt as array$2, o as cubicIn, ot as namespaces_default, p as now, q as sourceEvent_default, r as identity$1, rt as selector_default, s as cubicInOut, st as dispatch, t as zoom_default$1, tt as selectorAll_default, u as interrupt_default, v as interpolateTransformSvg, w as array_default, x as object_default, y as value_default, z as rgb } from "./src-D0GAwFZW.js";
...
function selectAll_default(selector) {
	return typeof selector === "string" ? new Selection([document.querySelectorAll(selector)], [document.documentElement]) : new Selection([array$2(selector)], root);
}
//#endregion
...
function contours_default() {
	...
	contours.thresholds = function(_) {
		return arguments.length ? (threshold = typeof _ === "function" ? _ : Array.isArray(_) ? constant_default$4(slice$1.call(_)) : constant_default$4(_), contours) : threshold;
	};
...
function density_default() {
	...
	density.thresholds = function(_) {
		return arguments.length ? (threshold = typeof _ === "function" ? _ : Array.isArray(_) ? constant_default$4(slice$1.call(_)) : constant_default$4(_), density) : threshold;
	};
...
var epsilon$4 = 11102230246251565e-32;
var splitter = 134217729;
var resulterrbound = 3.000000000000001 * epsilon$4;
...
var ccwerrboundA = (3 + 16 * epsilon$4) * epsilon$4;
var ccwerrboundB = (2 + 12 * epsilon$4) * epsilon$4;
var ccwerrboundC = (9 + 64 * epsilon$4) * epsilon$4 * epsilon$4;
var B = vec(4);
var C1 = vec(8);
var C2 = vec(12);
var D = vec(16);
...
(7 + 56 * epsilon$4) * epsilon$4;
(3 + 28 * epsilon$4) * epsilon$4;
(26 + 288 * epsilon$4) * epsilon$4 * epsilon$4;
vec(4);
vec(4);
vec(4);
vec(4);
...
vec(192);
vec(192);
(10 + 96 * epsilon$4) * epsilon$4;
(4 + 48 * epsilon$4) * epsilon$4;
(44 + 576 * epsilon$4) * epsilon$4 * epsilon$4;
vec(4);
vec(4);
vec(4);
vec(4);
...
vec(1152);
vec(1152);
(16 + 224 * epsilon$4) * epsilon$4;
(5 + 72 * epsilon$4) * epsilon$4;
(71 + 1408 * epsilon$4) * epsilon$4 * epsilon$4;
vec(4);
vec(4);
vec(4);
vec(4);
...
var tau$3 = 2 * Math.PI, pow$2 = Math.pow;
function pointX(p) {
	return p[0];
}
function pointY(p) {
...
function rotateRadians(deltaLambda, deltaPhi, deltaGamma) {
	return (deltaLambda %= tau$2) ? deltaPhi || deltaGamma ? compose_default(rotationLambda(deltaLambda), rotationPhiGamma(deltaPhi, deltaGamma)) : rotationLambda(deltaLambda) : deltaPhi || deltaGamma ? rotationPhiGamma(deltaPhi, deltaGamma) : rotationIdentity;
}
...
function polygonContains_default(polygon, point) {
	...
	for (var i = 0, n = polygon.length; i < n; ++i) {
		...
		for (var j = 0; j < m; ++j, lambda0 = lambda1, sinPhi0 = sinPhi1, cosPhi0 = cosPhi1, point0 = point1) {
			var point1 = ring[j], lambda1 = longitude(point1), phi1 = point1[1] / 2 + quarterPi, sinPhi1 = sin$1(phi1), cosPhi1 = cos$1(phi1), delta = lambda1 - lambda0, sign = delta >= 0 ? 1 : -1, absDelta = sign * delta, antimeridian = absDelta > pi$2, k = sinPhi0 * sinPhi1;
	...
	return {
		...
		point: function(lambda1, phi1) {
			...
			if (abs$1(delta - pi$2) < 1e-6) {
				...
				if (abs$1(lambda0 - sign0) < 1e-6) lambda0 -= sign0 * epsilon$2;
				if (abs$1(lambda1 - sign1) < 1e-6) lambda1 -= sign1 * epsilon$2;
...
function circle_default$1(radius) {
	var cr = cos$1(radius), delta = 2 * radians, smallRadius = cr > 0, notHemisphere = abs$1(cr) > epsilon$2;
	...
	function clipLine(stream) {
		...
		return {
			...
			point: function(lambda, phi) {
				var point1 = [lambda, phi], point2, v = visible(lambda, phi), c = smallRadius ? v ? 0 : code(lambda, phi) : v ? code(lambda + (lambda < 0 ? pi$2 : -pi$2), phi) : 0;
	...
	function intersect(a, b, two) {
		...
		var delta = lambda1 - lambda0, polar = abs$1(delta - pi$2) < epsilon$2, meridian = polar || delta < 1e-6;
		if (!polar && phi1 < phi0) z = phi0, phi0 = phi1, phi1 = z;
		if (meridian ? polar ? phi0 + phi1 > 0 ^ q[1] < (abs$1(q[0] - lambda0) < 1e-6 ? phi0 : phi1) : phi0 <= q[1] && q[1] <= phi1 : delta > pi$2 ^ (lambda0 <= q[0] && q[0] <= lambda1)) {
	...
	function code(lambda, phi) {
		var r = smallRadius ? radius : pi$2 - radius, code = 0;
		if (lambda < -r) code |= 1;
	...
	return clip_default(visible, clipLine, interpolate, smallRadius ? [0, -radius] : [-pi$2, radius - pi$2]);
}
//#endregion
...
function mercatorProjection(project) {
	...
	function reclip() {
		var k = pi$2 * scale(), t = m(rotation_default(m.rotate()).invert([0, 0]));
...
function conicConformalRaw(y0, y1) {
	...
	function project(x, y) {
		if (f > 0) {
			if (y < -halfPi$1 + 1e-6) y = -halfPi$1 + epsilon$2;
		} else if (y > halfPi$1 - 1e-6) y = halfPi$1 - epsilon$2;
...
function line_default(x$4, y$4) {
	...
	x$4 = typeof x$4 === "function" ? x$4 : x$4 === void 0 ? x : constant_default(x$4);
	y$4 = typeof y$4 === "function" ? y$4 : y$4 === void 0 ? y : constant_default(y$4);
	function line(data) {
	...
	line.x = function(_) {
		return arguments.length ? (x$4 = typeof _ === "function" ? _ : constant_default(+_), line) : x$4;
	};
	line.y = function(_) {
		return arguments.length ? (y$4 = typeof _ === "function" ? _ : constant_default(+_), line) : y$4;
	};
...
//#endregion
//#region node_modules/d3/node_modules/d3-shape/src/area.js
...
function pie_default() {
	var value = identity_default$1, sortValues = descending_default$1, sort = null, startAngle = constant_default(0), endAngle = constant_default(tau), padAngle = constant_default(0);
	function pie(data) {
...
//#endregion
//#region node_modules/d3/node_modules/d3-shape/src/curve/radial.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-shape/src/lineRadial.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-shape/src/areaRadial.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-shape/src/pointRadial.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-shape/src/link.js
...
function link(curve) {
	...
	link.x = function(_) {
		return arguments.length ? (x$3 = typeof _ === "function" ? _ : constant_default(+_), link) : x$3;
	};
	link.y = function(_) {
		return arguments.length ? (y$3 = typeof _ === "function" ? _ : constant_default(+_), link) : y$3;
	};
...
//#endregion
//#region node_modules/d3/node_modules/d3-shape/src/symbol/asterisk.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-shape/src/symbol/circle.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-shape/src/symbol/cross.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-shape/src/symbol/diamond.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-shape/src/symbol/diamond2.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-shape/src/symbol/plus.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-shape/src/symbol/square.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-shape/src/symbol/square2.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-shape/src/symbol/star.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-shape/src/symbol/triangle.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-shape/src/symbol/triangle2.js
var sqrt3 = sqrt$1(3);
...
//#endregion
//#region node_modules/d3/node_modules/d3-shape/src/symbol/wye.js
var c = -.5;
var s = sqrt$1(3) / 2;
var k = 1 / sqrt$1(12);
var a = (k / 2 + 1) * 3;
...
//#endregion
//#region node_modules/d3/node_modules/d3-shape/src/symbol/times.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-shape/src/symbol.js
var symbolsFill = [
	circle_default$2,
	cross_default,
	diamond_default,
...
function Symbol$1(type, size) {
	...
	type = typeof type === "function" ? type : constant_default(type || circle_default$2);
...
//#endregion
//#region node_modules/d3/node_modules/d3-shape/src/offset/none.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-shape/src/order/none.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-shape/src/stack.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-shape/src/offset/expand.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-shape/src/offset/diverging.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-shape/src/offset/silhouette.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-shape/src/offset/wiggle.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-shape/src/order/appearance.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-shape/src/order/ascending.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-shape/src/order/descending.js
function descending_default(series) {
	return ascending_default(series).reverse();
}
//#endregion
//#region node_modules/d3/node_modules/d3-shape/src/order/insideOut.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-shape/src/order/reverse.js
