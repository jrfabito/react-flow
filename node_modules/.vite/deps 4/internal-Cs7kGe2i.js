...
import { D as clsx, T as useStableCallback, _ as useReducedMotion, b as findUpUntil, i as useVisualRefresh, s as getBaseProps, y as warnOnce } from "./apply-display-name-YGZUDjdf.js";
...
import { a as useFunnelSubStep, b as nodeContains, d as findUpUntilMultiple, p as isContainingBlock, r as useFunnelStep, t as useFunnel, v as FunnelMetrics } from "./use-funnel-B_rqPr9n.js";
import { a as fireCancelableEvent, f as useSingleTabStopNavigation, i as useForwardFocus, l as isPlainLeftClick, n as KeyCode, p as nodeBelongs, r as checkSafeUrl, s as fireNonCancelableEvent, t as customCSSPropertiesMap } from "./custom-css-properties-BmCRz4uC.js";
import { t as useMergeRefs } from "./use-merge-refs-CYW-dG2H.js";
import { D as useUniqueId, E as useRandomId, S as getTextFromSelector, T as getAnalyticsMetadataAttribute, t as DATA_ATTR_ANALYTICS_ALERT, u as DATA_ATTR_FUNNEL_VALUE, v as getFunnelValueSelector, w as getAnalyticsLabelAttribute, y as getSubStepAllSelector } from "./selectors-DBN8FbfF.js";
import { n as with_native_attributes_default } from "./with-native-attributes-DOaSKZ_U.js";
import { a as reportRuntimeApiWarning, c as __assign, d as __extends, f as __rest, i as awsuiPluginsInternal, n as useInternalI18n, p as __spreadArray } from "./context-BS3sLYqs.js";
import { t as InternalIcon } from "./internal-CsM1mk_s.js";
import { i as useModalContext, n as useModalContextLoadingButtonComponent, t as InternalSpinner } from "./internal-GhB9Y7Mb.js";
import { t as internal_default } from "./internal-Dj3YAHaF.js";
import { n as getFirstScrollableParent, o as scrollRectangleIntoView, t as calculateScroll } from "./scrollable-containers-Crycj2C1.js";
import { t as LinkDefaultVariantContext } from "./link-default-variant-context-nXUFNg8u.js";
...
var styles_css_default$9 = { "root": "awsui_root_oip5a_160mh_5" };
//#endregion
...
function TabTrap({ focusNextCallback, disabled = false }) {
	return import_react.createElement("div", {
		className: styles_css_default$9.root,
...
var styles_css_default$8 = { "root": "awsui_root_1u26h_im8v7_5" };
//#endregion
...
function InternalTooltip({ content, getTrack, className, position = "top", onEscape, referrerId, __internalRootRef, ...restProps }) {
	...
	return import_react.createElement(Portal, null, import_react.createElement("div", {
		...baseProps,
		className: clsx(styles_css_default$8.root, baseProps.className),
...
function IconWrapper({ iconName, iconUrl, iconAlt, iconSvg, iconSize, badge, ...props }) {
	...
	return import_react.createElement(InternalIcon, {
		className: clsx(styles_css_default$7.icon, styles_css_default$7[`icon-${getIconAlign(props)}`], props.iconClass),
		name: iconName,
		url: iconUrl,
		svg: iconSvg,
		alt: iconAlt,
...
function LeftIcon(props) {
	if (props.loading) return import_react.createElement(InternalSpinner, { className: clsx(styles_css_default$7.icon, styles_css_default$7["icon-left"]) });
...
var styles_css_default$6 = { "label": "awsui_label_1f1d4_ocied_5" };
//#endregion
...
var InternalButton = import_react.forwardRef(({ children, iconName, __iconClass, __iconSize, onClick, onFollow, iconAlign = "left", iconUrl, iconSvg, iconAlt, variant = "normal", loading = false, loadingText, disabled = false, disabledReason, wrapText = true, href, external, target: targetOverride, rel, download, formAction = "submit", ariaLabel, ariaDescribedby, ariaExpanded, ariaHaspopup, ariaControls, fullWidth, badge, i18nStrings, style, nativeButtonAttributes, nativeAnchorAttributes, __internalRootRef, __focusable = false, __injectAnalyticsComponentMetadata = false, __title, __emitPerformanceMarks = true, __skipNativeAttributesWarnings, analyticsAction = "click", ...props }, ref) => {
	...
	const buttonClass = clsx(props.className, styles_css_default$7.button, styles_css_default$7[`variant-${variant}`], {
		[styles_css_default$7.disabled]: isNotInteractive,
		[styles_css_default$7["disabled-with-reason"]]: isDisabledWithReason,
		[styles_css_default$7["button-no-wrap"]]: !wrapText,
		[styles_css_default$7["button-no-text"]]: !shouldHaveContent,
		[styles_css_default$7["full-width"]]: shouldHaveContent && fullWidth,
		[styles_css_default$7.link]: isAnchor
	});
	...
	const buttonProps = {
		...
		...getAnalyticsLabelAttribute(shouldHaveContent ? `.${styles_css_default$6.label}` : "")
	};
	const iconProps = {
		loading,
		iconName,
	...
	const buttonContent = import_react.createElement(import_react.Fragment, null, import_react.createElement(LeftIcon, { ...iconProps }), shouldHaveContent && import_react.createElement(import_react.Fragment, null, import_react.createElement("span", { className: clsx(styles_css_default$7.content, styles_css_default$6.label) }, children), external && import_react.createElement(import_react.Fragment, null, "\xA0", import_react.createElement(InternalIcon, {
		name: "external",
		className: styles_css_default$5["external-icon"],
	...
	const disabledReasonContent = import_react.createElement(import_react.Fragment, null, descriptionEl, showTooltip && import_react.createElement(InternalTooltip, {
		className: styles_css_default$5["disabled-reason-tooltip"],
...
var styles_css_default$4 = { "root": "awsui_root_37gf8_1udtb_9" };
//#endregion
...
var ActionsWrapper = ({ className, testUtilClasses, action, discoveredActions, buttonText, wrappedClass, containerWidth, onButtonClick }) => {
	...
	return import_react.createElement("div", {
		ref,
		className: clsx(styles_css_default$4.root, className, wrapped && wrappedClass)
...
var styles_css_default$3 = { "header": "awsui_header_17427_1ns0c_5" };
//#endregion
...
var InternalAlert = import_react.forwardRef(({ type, i18nStrings, visible = true, dismissible, children, header, buttonText, action, onDismiss, onButtonClick, __internalRootRef, statusIconAriaLabel: deprecatedStatusIconAriaLabel, dismissAriaLabel: deprecatedDismissAriaLabel, messageSlotId, style, persistenceConfig, ...rest }, ref) => {
	...
	return import_react.createElement("div", {
		...
		...analyticsAttributes,
		"aria-hidden": !visible,
		className: clsx(styles_css_default$2.root, {
			[styles_css_default$2.hidden]: !visible,
			[styles_css_default$2["initial-hidden"]]: initialHidden
		}, baseProps.className),
		ref: containerRef
		...
		className: clsx(styles_css_default$2.alert, styles_css_default$2[`type-${type}`], styles_css_default$2[`icon-size-${size}`], hasAction && styles_css_default$2["with-action"], dismissible && styles_css_default$2["with-dismiss"]),
		style: getAlertStyles(style)
	}, import_react.createElement("div", { className: styles_css_default$2["alert-wrapper"] }, import_react.createElement("div", {
		className: styles_css_default$2["alert-focus-wrapper"],
		ref: focusRef,
		role: "group",
		onBlur: handleBlur
	}, import_react.createElement("div", {
		className: clsx(styles_css_default$2.icon, styles_css_default$2.text),
		...
		className: clsx(styles_css_default$2.message, styles_css_default$2.text),
		id: messageSlotId
	}, import_react.createElement("div", {
		className: clsx(header && styles_css_default$2.header, headerReplacementType !== "original" ? styles_css_default$2.hidden : styles_css_default$3.header),
		ref: headerRef
	}, header), import_react.createElement("div", {
		className: clsx(styles_css_default$2["header-replacement"], headerReplacementType !== "replaced" ? styles_css_default$2.hidden : styles_css_default$3.header),
		ref: replacementHeaderRef
	}), import_react.createElement("div", {
		className: clsx(styles_css_default$2.content, contentReplacementType !== "original" && styles_css_default$2.hidden),
		ref: contentRef
	}, children), import_react.createElement("div", {
		className: clsx(styles_css_default$2["content-replacement"], contentReplacementType !== "replaced" && styles_css_default$2.hidden),
		ref: replacementContentRef
	}))), import_react.createElement(ActionsWrapper, {
		className: styles_css_default$2.action,
		testUtilClasses: {
			actionSlot: styles_css_default$2["action-slot"],
			actionButton: styles_css_default$2["action-button"]
		},
		action,
		discoveredActions,
		buttonText,
		...
		containerWidth,
		wrappedClass: styles_css_default$2["action-wrapped"]
	})), dismissible && import_react.createElement("div", {
		className: styles_css_default$2.dismiss,
		...getAnalyticsMetadataAttribute({ action: "dismiss" })
	}, import_react.createElement(InternalButton, {
		className: styles_css_default$2["dismiss-button"],
		variant: "icon",
		iconName: "close",
		formAction: "none",
...
function ErrorBoundaryFallback({ i18nStrings = {}, renderFallback, ...props }) {
	...
	const defaultSlots = {
		header: import_react.createElement("div", { className: clsx(styles_css_default$1.header, styles_css_default.header) }, import_react.createElement(DefaultHeaderContent, { i18nStrings })),
		description: import_react.createElement("div", { className: clsx(styles_css_default$1.description, styles_css_default.description) }, import_react.createElement(DefaultDescriptionContent, { i18nStrings })),
		action: canUseRefresh() ? import_react.createElement("div", { className: clsx(styles_css_default$1.action, styles_css_default.action) }, import_react.createElement(DefaultActionContent, { i18nStrings })) : null
	};
	return import_react.createElement("div", {
		...baseProps,
		className: clsx(baseProps.className, styles_css_default.fallback)
...
function DefaultDescriptionContent({ i18nStrings: { descriptionText, components: { Feedback } = {} } = {} }) {
	...
	const formatArgs = Feedback ? {
		...
		Feedback: (chunks) => {
			var _a;
			return import_react.createElement("span", { className: styles_css_default["feedback-action"] }, import_react.createElement(Feedback, null, (_a = chunks[0]) !== null && _a !== void 0 ? _a : ""));
		}
	} : {
		hasFeedback: false,
...
function DefaultActionContent({ i18nStrings }) {
	...
	return import_react.createElement(InternalButton, {
		iconName: "refresh",
		onClick: refreshPage,
		className: styles_css_default["refresh-action"]
...
function InternalErrorBoundary({ children, suppressNested, suppressible, __internalRootRef, ...props }) {
	...
	return import_react.createElement("div", {
		ref: mergedRef,
		className: styles_css_default$1["error-boundary"],
...
function AppLayoutBuiltInErrorBoundary({ wrapper, suppressNested = false, children, renderFallback = () => import_react.createElement(import_react.Fragment, null) }) {
	...
	return import_react.createElement(ErrorBoundaryImpl, {
		...
		wrapper,
		renderFallback,
		className: styles_css_default$1["app-layout-part-fallback"],
		onError: (error) => {
			var _a;
...
//#endregion
export { styles_css_default$10 as A, useEffectOnUpdate as B, focus_lock_default as C, isFocusable as D, getLastFocusable as E, classNamesShape as F, getIsRtl as G, useHiddenDescription as H, require_prop_types as I, getLogicalPageX as J, getLogicalBoundingClientRect as K, _inheritsLoose as L, Transition$1 as M, forceReflow as N, TabTrap as O, TransitionGroupContext_default as P, _objectWithoutPropertiesLoose as R, PopoverBody as S, getFirstFocusable as T, ButtonContext as U, useDOMAttribute as V, Portal as W, getScrollInlineStart as X, getOffsetInlineStart as Y, InternalButton as _, styles_css_default$3 as a, styles_css_default$8 as b, createUseDiscoveredContent as c, persistFlashbarDismiss as d, retrieveFeatureNotifications as f, useVisualContext as g, getVisualContextClassname as h, InternalAlert as i, Transition as j, arrow_default as k, createUseDiscoveredAction as l, VisualContext as m, BuiltInErrorBoundary as n, ActionsWrapper as o, retrieveFlashbarDismiss as p, getLogicalClientX as q, InternalErrorBoundary as r, useContainerWidth as s, AppLayoutBuiltInErrorBoundary as t, persistFeatureNotifications as u, styles_css_default$7 as v, getAllFocusables as w, PopoverContainer as x, InternalTooltip as y, usePerformanceMarks as z };

//# sourceMappingURL=internal-Cs7kGe2i.js.map